...
* [Common areas for content improvement](/hw-docs/create-for-web-and-mobile/setting-up-worlds-for-web-and-mobile-compatibility#common-areas-for-content-improvement)
* [Feature references and examples](/hw-docs/create-for-web-and-mobile/setting-up-worlds-for-web-and-mobile-compatibility#feature-references-and-examples)
...
Further reading: [*Preview Device*](/hw-docs/desktop-editor/getting-started/preview-mode#preview-device)
...
Further reading: [*Action buttons*](/hw-docs/create-for-web-and-mobile/grabbable-entities/action-buttons/)
...
Further reading: [*Custom Input API Example*](/hw-docs/create-for-web-and-mobile/typescript-apis-for-mobile/custom-input-api/)
...
Further reading: [*Action buttons*](/hw-docs/create-for-web-and-mobile/grabbable-entities/action-buttons/), [*Holster button icons*](/hw-docs/create-for-web-and-mobile/grabbable-entities/holster-icon-menu/)
...
Further reading: [*Using performance tools from web and mobile*](/hw-docs/performance-best-practices-and-tooling/performance-tools/using-performance-tools-from-web-and-mobile)
...
Further reading: [*Image technical specifications*](/hw-docs/create-for-web-and-mobile/publishing-worlds-on-mobile#image-technical-specifications)
...
| Aim direction  [Guide](/hw-docs/create-for-web-and-mobile/grabbable-entities/aim-direction/) | *Editor Property* Set the “forwards” direction for a grabbable, ensuring that it looks correct & that any projectiles travel in the right direction. | [Citadel](https://horizon.meta.com/world/279976781332952) Used to set up the weapon launchers used heavily throughout the world. |
| Action icons  [Guide](/hw-docs/create-for-web-and-mobile/grabbable-entities/action-buttons/) | *Editor Property* Choose from a pre-defined set of icons for the on-screen “action” buttons. | [Horizon Central](https://horizon.meta.com/world/10161451989024108) Changes the use icon when picking up items e.g. drink icon for a drink. |
| Multi holstering  [Guide](/hw-docs/create-for-web-and-mobile/grabbable-entities/holster-icon-menu/) | *Editor Property*  Set the icon to use in the “holster” system UI (allowing mobile players to switch between several attached-to-avatar grabbables with on-screen buttons). | [Citadel](https://horizon.meta.com/world/279976781332952) Required to set up the weapon launchers used heavily throughout the world. |
...
| Grip pose  [Guide](/hw-docs/create-for-web-and-mobile/grabbable-entities/avatar-poses/) | *Editor Property* Set how the player’s avatar should hold a grabbable entity. |  |
| Crosshair selection  [Guide](/hw-docs/create-for-web-and-mobile/grabbable-entities/crosshair/) | *Editor Property* Enables creators to select from a predefined list of crosshairs, enhancing player aiming. | [Super Rumble](https://horizon.meta.com/world/10230277629074528) Used to select different crosshairs for the weapons (e.g. pistol vs rifle). |
...
| Throwing  [API Docs](https://horizon.meta.com/resources/scripting-api/core.player.throwhelditem.md) [Guide](/hw-docs/create-for-web-and-mobile/typescript-apis-for-mobile/throwing/) | *TypeScript* Enables triggering throwing the currently-held item through TypeScript, providing greater control over how the item is thrown (e.g. speed, pitch, handedness) |  |
| Aim assist  [Guide](/hw-docs/create-for-web-and-mobile/typescript-apis-for-mobile/aim-assist/) | *TypeScript* Enables creators to add aim assist to their world, generating a force to pull the camera towards a particular entity, player, or vector |  |
