...
![Set Player Camera](https://scontent-dfw5-2.xx.fbcdn.net/v/t39.2365-6/510881416_749600250911262_533806309759582464_n.png?_nc_cat=100&ccb=1-7&_nc_sid=e280be&_nc_ohc=9yhv38BCZNwQ7kNvwGIB5Fm&_nc_oc=Adns00b4AN11BrR80NJGkn1DOwM2b82vaMxL1jK7u-4qVp88bWDf0FRFwPjqqA4fWFc&_nc_zt=14&_nc_ht=scontent-dfw5-2.xx&_nc_gid=QRBh4Z3AJnVfXohKF4DqUw&oh=00_AfgcVZQTqx9tAEKzj4E0_rqgo0eOxnvYRaEoroT7IueUlQ&oe=692C01CA)
...
- **Enable the Camera API module:**
  ...
  * Click the **Settings** icon ![Script settings](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/452715951_512536464617643_2581711984717896530_n.png?_nc_cat=110&ccb=1-7&_nc_sid=e280be&_nc_ohc=7CbnO3ijE0AQ7kNvwFClDCV&_nc_oc=AdkxdTNVeLqHqjWDXSPgyG7-33tB1HzPyaHaC9DIQWPQRvKzVOokYyCibtP43eHrrlU&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=QRBh4Z3AJnVfXohKF4DqUw&oh=00_AfgXvwMVm6gPzgVZtSnKookg5GEN2Im87cgGKcySZs8y4Q&oe=692C07E8)
  * Enable **horizon/camera**![Enable Camera API module](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/557415887_835743098963643_369281294224086013_n.png?_nc_cat=101&ccb=1-7&_nc_sid=e280be&_nc_ohc=O48QG9b07zwQ7kNvwEJ1NxQ&_nc_oc=Adlv-y3DZF59NoLSoS9l5s8MAC_uAR9di-LNWE4_cALNAkWy3IBSKM9svS8_lH9M8-8&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=QRBh4Z3AJnVfXohKF4DqUw&oh=00_Afi2DPLkGKyWGwkN18IPbjfuh-y_cjVPaDpgaqL5eQ2c4A&oe=692BDE43)
- **Set Local execution mode:**
  * Set your script to execute in Local mode ![UI path to set Local execution mode](https://scontent-dfw5-2.xx.fbcdn.net/v/t39.2365-6/480543861_656120566925898_450547107366261658_n.png?_nc_cat=100&ccb=1-7&_nc_sid=e280be&_nc_ohc=jjb13PNDvA8Q7kNvwEDO2Ht&_nc_oc=AdmGo52sgf2M4Y6btzBxUh2W0Fd-xCynN9QmbATG9oPnnP0xTeV7m904fEJOriqnziQ&_nc_zt=14&_nc_ht=scontent-dfw5-2.xx&_nc_gid=QRBh4Z3AJnVfXohKF4DqUw&oh=00_Afjnn_iM9mVIomV2RHyWktQDnJj7KHWoVTq1BRF0QGh5yA&oe=692BE56E)
...
* Switching to [first-person camera mode](/horizon-worlds/learn/documentation/create-for-web-and-mobile/typescript-apis-for-mobile/camera/#how-to-set-the-first-person-camera-mode)
* Enabling [perspective switching](/horizon-worlds/learn/documentation/create-for-web-and-mobile/typescript-apis-for-mobile/camera/#how-to-enable-and-disable-perspective-switching)
...
For comprehensive documentation and examples, see [Portrait Camera API](/horizon-worlds/learn/documentation/typescript/api-references-and-examples/portrait-camera-api).

You can also configure orientation-specific camera parameters directly in the [spawn point gizmo’s Mobile Camera Options](/horizon-worlds/learn/documentation/code-blocks-and-gizmos/use-the-spawn-point-gizmo#mobile-camera-options) without scripting.

## Related documentation

* [Portrait Camera API](/horizon-worlds/learn/documentation/typescript/api-references-and-examples/portrait-camera-api) - Experimental API for orientation detection and control
* [Spawn Point Gizmo - Mobile Camera Options](/horizon-worlds/learn/documentation/code-blocks-and-gizmos/use-the-spawn-point-gizmo#mobile-camera-options) - Configure camera settings for different orientations
* [Preview Mode - Setting the Preview Device](/horizon-worlds/learn/documentation/desktop-editor/getting-started/preview-mode#setting-the-preview-device) - Test camera behavior in different orientations