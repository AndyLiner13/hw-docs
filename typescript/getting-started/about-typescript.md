...
* You are limited to 64k in script size on worlds that don’t use [File-Backed Scripts](/hw-docs/typescript/filebacked-scripts/).

## API versions

All new Meta Horizon worlds use TypeScript API version 2.0 by default. We strongly recommend that you upgrade to this version if you haven’t already, because prior versions are no longer updated. For more information on this, see [Upgrade World to TypeScript API v2.0.0](/hw-docs/typescript/upgrade-world-to-typescript-api-v200).
