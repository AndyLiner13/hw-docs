...
![](https://scontent-dfw5-2.xx.fbcdn.net/v/t39.2365-6/452532429_512524664618823_2690924150930112816_n.png?_nc_cat=100&ccb=1-7&_nc_sid=e280be&_nc_ohc=NQYxXjnxPD4Q7kNvwFdNyAD&_nc_oc=AdnOyJ-xAKu6wobI7fbIXpaV33EIhXQ99eTvuUthBFqX2QRJZCvYd8Od-J5VaFV6ico&_nc_zt=14&_nc_ht=scontent-dfw5-2.xx&_nc_gid=qLuGsoVzkG5z74fsF_DWYA&oh=00_AfgBCpREsBeYgLrPmqFTEsc98V38B68w_Z4PkvnVKnpOYA&oe=692C07F3)
...
**Note:** When ownership transfers, state details are actually lost. The script shuts down on the old owner client, and then restarts on the new owner client. So you must package the state data and repopulate the properties, which are on the same entity. For details, see [Ownership transfer between clients](/hw-docs/typescript/local-scripting/ownership-in-horizon-worlds#ownership-transfer-between-clients).
