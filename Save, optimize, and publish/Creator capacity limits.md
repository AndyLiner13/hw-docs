...
# [Creator capacity limits](#creator-capacity-limits)
...
## [To check capacity levels:](#to-check-capacity-levels)

1. In Build mode, open your Creator Menu by pressing the menu button on your left controller.
2. Select **World**.
3. Select **Capacity**.
