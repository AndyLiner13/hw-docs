...
# [Learn about Frame Budget Boost](#learn-about-frame-budget-boost)
...
## [Frame Budget Boost requirements](#frame-budget-boost-requirements)
...
## [Manage Frame Budget Boost settings](#manage-frame-budget-boost-settings)

To manage Frame Budget Boost as a world creator:

1. Open the Creator UI.
2. Select the **World Settings** tab.
3. Select **Player Settings** in the left menu.
4. Find **Frame Budget Boost** and select the applicable dropdown.

The default setting for Frame Budget Boost will result in a small percentage of visitors to your world experiencing “Frame Budget Boost”. You can override the default setting to turn Frame Budget Boost on/off for all the visitors in your world.

## [Frame Budget Boost visual artifacts](#frame-budget-boost-visual-artifacts)
