...
## [Who can publish different worlds?](#who-can-publish-different-worlds)
...
## [How digital goods are rated](#how-digital-goods-are-rated)

Every digital good in Worlds receives a rating indicating its suitability for different age groups. Creators must select an age rating when publishing an item, which is then visible to all users with access to an appropriate age group. Inaccurate ratings may result in unpublishing of the item.
...
## [What’s not allowed in Worlds?](#whats-not-allowed-in-worlds)
