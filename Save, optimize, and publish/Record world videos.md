...
| **Toggle** | **What it does** |
| --- | --- |
| Camera mode | Choose the POV of your camera.  *Single Camera*: Full-screen, controllable camera. See controls for single camera [below](/hw-docs/Save,%20optimize,%20and%20publish/Record%20world%20videos.md#controls-for-single-camera-mode).  *Player POV*: Records from the player’s perspective (the way it looks during gameplay). The camera will follow behind the player. |
