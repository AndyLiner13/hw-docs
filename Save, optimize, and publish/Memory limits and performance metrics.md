...
# [Memory limits and performance metrics](#memory-limits-and-performance-metrics)
...
## [Access the Real-time metrics panel](#access-the-real-time-metrics-panel)
...
3. Open your menu and Select **Settings**.
4. Select the **Utilities** tab and enable the utilities menu.
5. Once the wearable is open, select the **Real-time metrics** button under Utilities to open the Real-time metrics panel.
...
### [Move the panel using settings](#move-the-panel-using-settings)

To change the position of the Real-time metrics panel:

1. Open the display settings by pressing the **settings button** on the top right of the panel.
2. Select a position from the **Position** drop-down in Display Settings.

You may choose from **Top Left**, **Top Right**, **Bottom Left**, and **Bottom Right**. This snaps the Real-time metrics panel to one of those locations in your view.

### [Move the panel by dragging](#move-the-panel-by-dragging)
...
#### [Select metrics to display](#select-metrics-to-display)

1. Select **Settings** on the Real-time metrics panel to open the display settings.
2. Under Graphs, there are checkboxes for the metrics that are available.
3. Point at the display settings panel and use either joystick to scroll up and down to see even more metrics. Full descriptions of each available metric are listed at the end of this section, under Real-time Metric Descriptions.
4. To add a metric to the Real-time metric panel, open the display settings, hover your controller pointer over a metric with an empty check box, and pull the trigger. The metric is added to the panel with a unique color identifier.
...
#### [Change metric targets](#change-metric-targets)
