...
- **Create the quest container hierarchy**: Navigate to your world hierarchy and create a empty object for the **QuestsContainer** entity. This will serve as the parent for all quest entities and the central hub for quest management.
  ...
  ![Quests container entity](https://scontent-dfw5-2.xx.fbcdn.net/v/t39.2365-6/547700371_817222417482378_4514483849404297810_n.png?_nc_cat=104&ccb=1-7&_nc_sid=e280be&_nc_ohc=_tIl73ABRgUQ7kNvwFMRzx4&_nc_oc=AdmMv4umkclLLAwRgc6Nw3s0U9lje705ckNXocq_SSYALNySy5OjxBiDChvL8Y40Ze0&_nc_zt=14&_nc_ht=scontent-dfw5-2.xx&_nc_gid=CFsbBFksPchJ64VUoo7hpQ&oh=00_AfiVWf1r4-Bqkb7XLN2wo0jxha5w4NEK1j6gJ6dEclKweA&oe=692C0B5D)
...
- **Setup dialogue tree structure**: Create dialogue nodes as child entities of your NPC. For each dialogue interaction, you’ll need:
  ...
  * **Multiple choice support**: You can create up to 3 response options per dialogue node by duplicating NodeOption objects
  ...
  ![Dialogue tree structure](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/549700973_817222424149044_1566131082991758206_n.png?_nc_cat=101&ccb=1-7&_nc_sid=e280be&_nc_ohc=pTnvTLeaHx8Q7kNvwFSh0v0&_nc_oc=AdlgYwp8uypibzSxxq0-cRDDNr4d3fk0fVpFx8NCcrTUsWaYDJ_gDxehcXfYdalfvrQ&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=CFsbBFksPchJ64VUoo7hpQ&oh=00_AfjIR9zFVpV2Sck1pykpYExJwHRf6fnVxuOR85Zxj1YoQQ&oe=692C0E55)
...
- **Setup quest waypoints**: Navigate to the **Asset Library** and locate quest waypoint assets. Place **Asset Pool Gizmos** at quest locations and attach the `QuestWaypointController.ts` script. Configure waypoints to:
  ...
  * **Event Integration**: Connect to quest system for automatic activation
  ...
  ![Waypoint setup](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/547833423_817222427482377_5929807082470367194_n.png?_nc_cat=111&ccb=1-7&_nc_sid=e280be&_nc_ohc=P-kZrOdO1Q4Q7kNvwFoR9eE&_nc_oc=Adl7leENgjYfC3yxUdmGtqiQkpYYvI_6MaReYGP0hUFTMfbeX37NuE3UUj-Mo-3Qy4Q&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=CFsbBFksPchJ64VUoo7hpQ&oh=00_Afjivu9lsi0vEIwK_6-eD6MwKSgGuIrWt4UQ33pJuYNHjw&oe=692BF733)
...
- **Test the quest flow**: Walk through the complete player journey:
  ...
  * **Progression**: Verify quest state updates and system integration
  ...
  ![Quest flow testing](https://scontent-dfw5-3.xx.fbcdn.net/v/t39.2365-6/548210265_817222430815710_571828785668804832_n.png?_nc_cat=108&ccb=1-7&_nc_sid=e280be&_nc_ohc=uTSNujR4rGIQ7kNvwGwITjo&_nc_oc=Admj6vRoLPgKuWWueo4PE7oBv7lYCYYW2ypf07VbpnCTgxk0W7kpx2DSeG91SkfPIFg&_nc_zt=14&_nc_ht=scontent-dfw5-3.xx&_nc_gid=CFsbBFksPchJ64VUoo7hpQ&oh=00_AfizYPSzcSEVkaLLTsV6x9d9aNc6HAHHgWOcKpd4USOcEA&oe=692C0DA1)
