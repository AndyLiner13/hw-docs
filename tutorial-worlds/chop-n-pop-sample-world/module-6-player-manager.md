...
* Private functions manage:
  ...
  + Moving players from the game back to the lobby (players move themselves into the game area. Gameplay is triggered by breaching a Trigger Zone entity. See [Module 4 - Game Manager](/hw-docs/tutorial-worlds/chop-n-pop-sample-world/module-4-game-manager).).
