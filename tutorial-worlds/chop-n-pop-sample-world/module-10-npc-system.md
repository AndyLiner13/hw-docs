...
For more information on navigation meshes (NavMesh) and agent profiles, see [Navigation Mesh Generation](/hw-docs/desktop-editor/npcs/navigation-mesh-generation).
...
- The asset and its behavior script are now available for you to use the world of your choice.
...
This module introduces the NavMesh and navigation profile concepts, which are significant topics by themselves. See [Navigation Mesh Generation](/hw-docs/desktop-editor/npcs/navigation-mesh-generation).
