...
# [Upgrade World to TypeScript API v2.0.0](#upgrade-world-to-typescript-api-v200)
...
## [Upgrading your world](#upgrading-your-world)
...
3. Click the scripts icon.
   ...
   ![The scripts icon.png](../.assets/image/cb0fa18fd8fd280a16cd0feb5f9bd1a4f6344c20926ec1617ff2ab044b2e3215.png)

4. In the Scripts panel, click the **Settings** icon.

   ![The settings icon.png](../.assets/image/77a6629ff926d76b02c2f7cf67ecf1882350067741d62649a354d831820a3e27.png)
...
6. Select **2.0.0** from the **API** version list.
   ...
   ![The API version list.png](../.assets/image/c40e74b2b66e1ebca717fcfb872a9b334307a26caf38bf721e44e8805a732f1c.png)

7. Enable the API modules that you use in your world.

   ![Scripts settings.png](../.assets/image/439c10e9fb9e7f250d6b9ce2d3c030f7d198bff88e3337e6438be6017e5e1f38.png)

8. Click **Apply**.

## [Fixing script validation errors](#fixing-script-validation-errors)
...
### [Fix Props and class declarations](#fix-props-and-class-declarations)
...
### [Fix properties references](#fix-properties-references)
