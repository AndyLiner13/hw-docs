...
# [Getting Started with Local Scripting](#getting-started-with-local-scripting)
...
## [Set a script to run locally](#set-a-script-to-run-locally)

To set your script to run in local scripting mode in Desktop Editor, perform the following steps.

1. In Desktop Editor, select **Scripts** in the menu bar to open the Scripts panel. ![](../../_assets/images/9fc6e492f9c2e5c210d1922f7abe9d014c5f872cfb7d691d87f185e51f257eb6.png)
2. Click the more options menu of your script and change the **Script Execution Mode** from **Default** to **Local**.

![](../../_assets/images/d052c7db1c0872c9bcb97e4e9d60c9957aac9a30850861c4c2358dc2b9265282.png)
...
### [The `start()` method is called](#the-start-method-is-called)
...
### [Entity properties aren’t changed](#entity-properties-arent-changed)
...
### [Behaviors to note](#behaviors-to-note)

#### [`OnPlayerExitWorld` isn’t received by local scripts](#onplayerexitworld-isnt-received-by-local-scripts)
...
#### [`OnPlayerEnterWorld` and `OnPlayerExitWorld` aren’t received by local scripts](#onplayerenterworld-and-onplayerexitworld-arent-received-by-local-scripts)
...
#### [`OnGrabEnd` and `OnAttachEnd` aren’t received when owner exits world](#ongrabend-and-onattachend-arent-received-when-owner-exits-world)
...
#### [Persistent Variables API is inaccessible in local scripts](#persistent-variables-api-is-inaccessible-in-local-scripts)
...
#### [Local scripts can’t listen for local events received by default scripts (and vice versa)](#local-scripts-cant-listen-for-local-events-received-by-default-scripts-and-vice-versa)
...
#### [Local events can only communicate with local events with the same owner](#local-events-can-only-communicate-with-local-events-with-the-same-owner)
...
#### [Local scripts can’t trigger asset spawning](#local-scripts-cant-trigger-asset-spawning)
...
#### [Local scripts can’t access texture assets](#local-scripts-cant-access-texture-assets)
