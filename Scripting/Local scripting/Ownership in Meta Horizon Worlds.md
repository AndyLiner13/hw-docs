...
# [Ownership in Meta Horizon Worlds](#ownership-in-meta-horizon-worlds)
...
## [Where scripts execute](#where-scripts-execute)
...
![](../../.assets/image/e5f7f793767634c3da6673644e11cb933bd35ea67578b1b0a225e9e395a7aa21.png)
...
## [Automatic ownership transfer](#automatic-ownership-transfer)
...
## [Manual ownership transfer](#manual-ownership-transfer)
...
## [Ownership transfer between clients](#ownership-transfer-between-clients)
...
2. **ClientA** calls [`transferOwnership()`](https://horizon.meta.com/resources/scripting-api/core.component.transferownership.md/?api_version=2.0.0). You can implement this optional method in your script to return state details that are sent to the instance of the script component that will run on ClientB.
...
6. **ClientB** calls [`receiveOwnership()`](https://horizon.meta.com/resources/scripting-api/core.component.receiveownership.md/?api_version=2.0.0). All of the states that you send from ClientA are received by ClientB. You can use it to persist state between clients.

## [When to prevent ownership transfer](#when-to-prevent-ownership-transfer)
