...
## [Select or Create Variable Group](#select-or-create-variable-group)
...
2. From the menubar, select the **Systems menu**. Then, select **Variable Groups**.
   ...
   ![](../../_assets/images/5bb5ecfd4102d0452124f057ddd25a9b782a5c3368a824136f6bb948d9bf3469.png)
...
4. In the Create Variable Group dialog:
   1. **Name**: Enter a name for the variable group. This name is displayed in the user interface and is referenced in any TypeScript that you use to access the variable group.
...
## [Create an Object-type persistent variable](#create-an-object-type-persistent-variable)
...
1. If you have not done so already, select the variable group in which to store your persistent variable.

2. The name of your variable group and all persistent variables that it contains is displayed:

   ![](../../_assets/images/105c11cba5659bb87d47df8e0d4e1346ca53367527c798c8aa8e5a3a6d5e31aa.png)

3. Next to the name of the variable group, click the **+ icon**.

4. In the Create Variable dialog:
   1. **Name**: Enter the name of the variable. This name is displayed in the user interface and is referenced in any TypeScript that you use to access the variable.
...
## [Access persistent variables via TypeScript](#access-persistent-variables-via-typescript)

### [API module and references](#api-module-and-references)
...
### [Setting values for persistent variables](#setting-values-for-persistent-variables)
...
### [getPlayerVariable](#getplayervariable)
...
### [setPlayerVariable](#setplayervariable)
...
#### [Object example](#object-example-1)
...
#### [Number example](#number-example-1)
...
### [Create a module to store variable names](#create-a-module-to-store-variable-names)
...
### [Create a type alias to variable structure](#create-a-type-alias-to-variable-structure)
