...
# [Modules and Global Functions](#modules-and-global-functions)
...
## [Creating Modules in Meta Horizon Worlds](#creating-modules-in-meta-horizon-worlds)
...
### [Creating Modules in Desktop Editor](#creating-modules-in-desktop-editor)
...
4. Select the contextual menu of the newly created script to display its configuration options, or to edit it using an external IDE.
