...
# [Using TypeScript in Meta Horizon Worlds](#using-typescript-in-meta-horizon-worlds)
...
## [Edit an existing script](#edit-an-existing-script)
...
## [Recompile an existing script](#recompile-an-existing-script)
...
## [Delete an existing script](#delete-an-existing-script)
...
## [An example of a simple script](#an-example-of-a-simple-script)
