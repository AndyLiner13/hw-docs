...
# [TypeScript Components, Properties, and Variables](#typescript-components-properties-and-variables)
...
- [Properties - modify the component](TypeScript%20Components%2C%20Properties%2C%20and%20Variables.md#properties-and-variables)
- [Variables - define the capabilities of a component](TypeScript%20Components%2C%20Properties%2C%20and%20Variables.md#properties-and-variables)
...
## [TypeScript Component Lifecycle](#typescript-component-lifecycle)

The following outlines the component creation sequence:

1. The life cycle begins when the world starts or is reset. All user TypeScripts are compiled and executed at that time.
2. Any TypeScript components that are registered via `Component.register` are registered as a TypeScript component definition. This is essentially a factory that we can use to create instances of this component.
3. Entities that have a TypeScript component attached to them in the entity property panel will be instantiated. This also applies to property overrides or defaults.
4. The `start` method is called on every TypeScript component instance. Any future script logic can be run by callbacks.
...
## [Registering and Attaching Components to Entities](#registering-and-attaching-components-to-entities)
...
2. Entities sent through a script using Events (see [Events section](../Events/Local%20Events.md) )
3. Entities spawned into the world (see [Asset Spawning section](../Asset%20spawning/Checking%20for%20Asset%20Spawn%20Events.md))
