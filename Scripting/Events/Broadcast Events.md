...
## [Event behavior for local vs. server script execution](#event-behavior-for-local-vs-server-script-execution)
...
> [!Warning] Maintaining broadcast event subscriptions can slow your event messaging as more subscriptions are added. If your objects no longer need to listen for broadcast events, you can [unsubscribe from these sources](Events%20Best%20Practices.md) to improve performance.

## [Creating a broadcast event](#creating-a-broadcast-event)
...
## [Sending broadcast events](#sending-broadcast-events)
...
## [Subscribing to broadcast events](#subscribing-to-broadcast-events)
