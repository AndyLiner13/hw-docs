...
## [Delaying events with async.setTimeout()](#delaying-events-with-asyncsettimeout)
...
## [Consolidating common events](#consolidating-common-events)
...
## [CodeBlock interoperability](#codeblock-interoperability)
