...
# [CodeBlock Events](#codeblock-events)
...
## [Creating a custom CodeBlock event](#creating-a-custom-codeblock-event)
...
## [Sending CodeBlock events](#sending-codeblock-events)
...
## [Subscribing to CodeBlock events](#subscribing-to-codeblock-events)
...
## [Example - Sending to CodeBlocks](#example---sending-to-codeblocks)
...
## [Example - Sending to TypeScript](#example---sending-to-typescript)
...
## [Example - Sending an event to a Player](#example---sending-an-event-to-a-player)
...
## [Built-in CodeBlock events](#built-in-codeblock-events)
...
### [Subscribe to built-In CodeBlock events](#subscribe-to-built-in-codeblock-events)
