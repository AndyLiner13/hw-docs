...
To check if an Entity is visible to a specific player in a world instance, call the `isVisibleToPlayer()` method on the `Entity` object. For details, see the [Entity.isVisibleToPlayer method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Entity.md#isvisibletoplayer) in the API reference documentation.
...
* [Entity.setVisibleToPlayers method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Entity.md#setvisibletoplayers)
* [Entity.resetVisibilityForPlayers method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Entity.md#resetvisibilityforplayers)
