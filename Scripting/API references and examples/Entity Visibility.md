...
## [Checking entity visibility](#checking-entity-visibility)

To check if an Entity is visible to a specific player in a world instance, call the `isVisibleToPlayer()` method on the `Entity` object. For details, see the [Entity.isVisibleToPlayer method](../../Reference/core/Classes/Entity.md#isvisibletoplayer) in the API reference documentation.

## [Updating entity visibility](#updating-entity-visibility)
...
- [Entity.setVisibleToPlayers method](../../Reference/core/Classes/Entity.md#setvisibletoplayers)
- [Entity.resetVisibilityForPlayers method](../../Reference/core/Classes/Entity.md#resetvisibilityforplayers)
