...
The `World.matchmaking.allowPlayerJoin()` method indicates whether a user can or cannot join an instance at a given time. For details, see the [World.matchmaking.allowPlayerJoin method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md) in the API reference documentation.
