...
# [Horizon TypeScript V2 Changes](#horizon-typescript-v2-changes)
...
| [Component](../Get%20started%20with%20TypeScript/TypeScript%20Components%2C%20Properties%2C%20and%20Variables.md) | Major        | - Reduced the amount of boilerplate code required to create components in scripts. - Added a `prestart` method to the `Component` class.                                                                                                           |
...
### [Entity and Asset properties](#entity-and-asset-properties)
