...
* [OnAchievementComplete CodeBlock event](/hw-mcp-tools/documentation/hw-docs/Reference/core/Variables/CodeBlockEvents.md) - This is a built-in CodeBlock event that is called when a player completes a specified achievement.
* [Player.hasCompletedAchievement method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md#hascompletedachievement) - Verifies whether the player has completed the specified achievement.
* [Player.setAchievementComplete method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md#setachievementcomplete) - Specifies whether a player has completed the given achievement.
