...
## [Getting a Player’s Index](#getting-a-players-index)

To retrieve a Player’s index in the world, use the `index.get()` function on a Player object. For details, see the [Player.Index property](../../Reference/core/Classes/Player.md#index) in the API reference documentation.

## [Getting a Player from an Index](#getting-a-player-from-an-index)

To retrieve a Player object based on a Player Index value, use the `getPlayerFromIndex()` function on the `this.world` object. For details, see the [World.getPlayerFromIndex method](../../Reference/core/Classes/World.md#getplayerfromindex) in the API reference documentation.
