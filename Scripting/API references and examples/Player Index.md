...
To retrieve a Player’s index in the world, use the `index.get()` function on a Player object. For details, see the [Player.Index property](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md) in the API reference documentation.

## Getting a Player from an Index

To retrieve a Player object based on a Player Index value, use the `getPlayerFromIndex()` function on the `this.world` object. For details, see the [World.getPlayerFromIndex method](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) in the API reference documentation.
