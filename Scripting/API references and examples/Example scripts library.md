...
The example scripts in this document illustrate ways to accomplish common tasks using the [Meta Horizon Worlds TypeScript API](../Scripting%20using%20TypeScript.md).

## [Detach an entity from a player](#detach-an-entity-from-a-player)
...
## [Stop an animation for an entity](#stop-an-animation-for-an-entity)
...
## [Teleport a player to a specific location](#teleport-a-player-to-a-specific-location)
...
## [Set who can grab a grabbable entity](#set-who-can-grab-a-grabbable-entity)
...
## [Attach an attachable entity to a player](#attach-an-attachable-entity-to-a-player)
...
## [Detach an attachable entity from a player](#detach-an-attachable-entity-from-a-player)
...
## [Check if a player has completed an achievement](#check-if-a-player-has-completed-an-achievement)
...
## [Clear an aim assist target for a player](#clear-an-aim-assist-target-for-a-player)
...
## [Launch a projectile from a launcher](#launch-a-projectile-from-a-launcher)
...
## [Enable or disable a TriggerGizmo](#enable-or-disable-a-triggergizmo)
...
## [Unfocus a player’s UI](#unfocus-a-players-ui)
...
## [Play an avatar grip pose animation when a player enters the world](#play-an-avatar-grip-pose-animation-when-a-player-enters-the-world)
...
## [Move an entity to a specific position](#move-an-entity-to-a-specific-position)
...
## [Toggle the visibility of an entity](#toggle-the-visibility-of-an-entity)
...
## [Make an entity collidable](#make-an-entity-collidable)
...
## [Retrieve the position of a player](#retrieve-the-position-of-a-player)
...
## [Change gravity for a player](#change-gravity-for-a-player)
...
## [Change speed for a player](#change-speed-for-a-player)
...
## [Retrieve a player’s device type](#retrieve-a-players-device-type)
...
## [Retrieve a player’s variable from persistent storage](#retrieve-a-players-variable-from-persistent-storage)
...
## [Set a player’s variable in persistent storage](#set-a-players-variable-in-persistent-storage)
