...
* **Full or partial mutes trigger in-app notifications, emails, and a gizmo flash**: When a sound in your world is muted (either in full or partially), you’ll receive in-app notifications and emails alerting you. The emails provide a link for disputes to [Using audio recording in Worlds](/hw-docs/sounds-physics-and-automation/using-music-audio-recordings-horizon-worlds). Gizmos with any mute flash red.
* **Appeal support**: If you believe that you have the rights to use blocked or muted content, follow the process outlined at [Using audio recording in Worlds](/hw-docs/sounds-physics-and-automation/using-music-audio-recordings-horizon-worlds). In addition to notification emails, this link is also provided in the banner on the sound recorder that alerts when mutes occur.
