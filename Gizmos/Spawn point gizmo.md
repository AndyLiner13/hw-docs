...
## [Access and use the spawn point gizmo](#access-and-use-the-spawn-point-gizmo)
...
## [Spawn point properties](#spawn-point-properties)
...
### [Mobile camera options](#mobile-camera-options)
...
- **Mobile Camera**: A mobile-specific setting which allows you to configure camera behavior. This can greatly improve the accessibility to your world for mobile users.
  ...
  ![Screenshot shows the desktop editor](../.assets/image/2812af9d270bf7ccf362cd4a885079de5a48fa406d36e8fa5c95bc159a5ab893.png)
...
- **Portrait/Landscape separation**: You can define different visual parameters for each orientation to optimize the player experience across different device orientations
  ...
  ![Screenshot shows the desktop editor](../.assets/image/1e6222609376dd8a754516dc6322de8988b272ed4c08e32f82e7db2b967441e2.png)

## [Preview and publishing configuration](#preview-and-publishing-configuration)

### [Preview orientation simulation](#preview-orientation-simulation)

When testing your world in the desktop editor, you can simulate different device orientations:

1. In [**Preview Configuration**](../Desktop%20editor/Get%20started%20with%20Desktop%20Editor/Preview%20mode.md#setting-the-preview-device) options, locate the **Preview orientation** setting under **Mobile and Web device simulations**.
2. Change the setting to **Portrait** to simulate how the world appears in portrait orientation.
3. This allows you to test and validate your spawn point camera configurations before publishing.

### [World orientation publishing](#world-orientation-publishing)

When publishing your world, you can specify the target orientation:

1. In the [**Publish World**](../Desktop%20editor/Settings/World%20Settings%20Modification.md#changing-world-settings) panel, navigate to the **Advanced** section.
2. Set the **World Orientation** option to **Portrait** to mark your world for portrait orientation.
3. Use **Save for later** to prepare your world configuration without immediately publishing.
...
1. In **Script Settings**, access the `horizon/portrait_camera` API module.
2. The `PortraitCamera` class extends the standard `Camera` class with a `currentOrientation` property.
3. This property returns either **PORTRAIT** or **LANDSCAPE** based on the current simulation settings.
...
- [Create your first world tutorial: designate a spawn point](../Tutorials/Getting%20started/Create%20your%20first%20world%20tutorial%2C%20part%201.md#section-2-place-assets-in-the-scene)
