...
![Shop Gizmo in Meta Horizon Worlds](../_assets/images/39ec4bc4b7cd4aeb39aa06858bb57392b942f6ecb8c8bbe1882e020a1496b40a.png)
...
## [Access the shop gizmo](#access-the-shop-gizmo)
...
## [Shop gizmo properties](#shop-gizmo-properties)
...
## [Screen Overlay mode](#screen-overlay-mode)
...
## [Listening to Shop Purchases](#listening-to-shop-purchases)
...
log
(
`Player ${payload.playerId} purchased ${payload.grantItemQuantity} of item ${payload.grantItemSku}`
);
