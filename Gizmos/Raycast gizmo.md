...
You can also use [Raycast gizmo API](/hw-docs/Reference/core/Classes/RaycastGizmo.md) to define the properties.

| Property | Type | Description |
| --- | --- | --- |
| Collide With | `Players`, `Objects Tagged`, or `Both` | Sets which [collision layer(s)](/hw-docs/Reference/core/Enumerations/LayerType.md) the raycast will interact with. |
| Object Tag | `string` | When the **Collide With** property is **Objects Tagged** or **Both** this specifies which [entity tag](/hw-docs/Reference/core/Classes/Entity.md#properties) the raycast will activate on. |
...
Raycast gizmos are referenced using the [as()](/hw-docs/Reference/core/Classes/Entity.md#methods) method, for example:

```
    const laserGizmo = this.props.laserProjector.as(RaycastGizmo);
```

The result of the raycast collision is [RaycastHit](/hw-docs/Reference/core/Type%20Aliases/RaycastHit.md) with the [target types](/hw-docs/Reference/core/Enumerations/RaycastTargetType.md), Entity, Player, and Static, during the raycast collision.

## What’s next?

Try the following tutorial worlds with code samples and related guides:

* [Simple shooting mechanics](/hw-docs/Tutorials/Simple%20Shooting%20Mechanics%20tutorial/Module%204%20-%20Laser%20Gun.md#raycast-gizmo)
* [Use tap inputs to interact with a keypad](/hw-docs/Tutorials/Developing%20for%20Web%20and%20Mobile%20Players%20tutorial/Module%207C%20-%20Use%20tap%20inputs%20to%20interact%20with%20a%20keypad.md)
