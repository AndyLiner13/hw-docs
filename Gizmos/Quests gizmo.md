...
The quests gizmo is an entity. All objects in a world are represented by entities. [Entities](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Entity.md) have their respective properties such as position, rotation, and scale. In the Properties panel, you can edit the gizmo’s transformation fields to configure its Position, Rotation, and Scale. Additionally, like the transformation, [Color](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Color.md) can be edited in the UI panel or controlled through scripting.
...
To display player achievements, use the `displayAchievements` method in the [AchievementGizmo](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/AchievementsGizmo.md) class.

To set and query if an achievement is complete, use the `setAchievementComplete` and `hasCompletedAchievement` methods in the [Player](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md) class.

Additionally, built-in [`CodeBlockEvents`](/hw-mcp-tools/documentation/hw-docs/Reference/core/Variables/CodeBlockEvents.md) are available to listen for events such as when an achievement has been completed: `OnAchievementComplete`.
...
* [Tutorial worlds on quests](/hw-mcp-tools/documentation/hw-docs/Tutorials/Scripted%20Avatar%20NPC%20tutorial/Module%205%20-%20Quest%20Manager.md)
