...
* [Part 1](/horizon-worlds/learn/documentation/get-started/create-your-first-world) shows you how to create a new world, then place an asset in your newly created world, manipulate that asset using the desktop editor before previewing your world, and finally playing in your world on a mobile device.
