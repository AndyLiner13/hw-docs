...
Therefore, the correct implementation for the button with hover state needs to take [the acting player](/hw-docs/desktop-editor/custom-ui/building-interactive-custom-ui/) into account, and only manipulate the player specific value:
