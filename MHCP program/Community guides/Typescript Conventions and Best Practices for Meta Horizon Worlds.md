...
A ‘future you’ will thank yourself if you write down what you were thinking when you wrote your code! However, do not comment pedantically, and make sure you have [used descriptive names](/hw-mcp-tools/documentation/hw-docs/MHCP%20program/Community%20guides/Typescript%20Conventions%20and%20Best%20Practices%20for%20Meta%20Horizon%20Worlds.md#naming) for your variables and functions, as that can make extra comments unnecessary. Only comment the *important* things, and comment things that the VSCode hover popups will pick up, such as documentation comments on functions describing its effects, parameters, and return values.
...
* [recommendedTypeChecked](https://typescript-eslint.io/users/configs#recommended-type-checked)
  ...
  + Requires a minor amount of [extra configuration](/hw-mcp-tools/documentation/hw-docs/MHCP%20program/Community%20guides/Typescript%20Conventions%20and%20Best%20Practices%20for%20Meta%20Horizon%20Worlds.md#appendix)
