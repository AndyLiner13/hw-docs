...
* **In-World Purchases:** Create items that can be used in-world. Users can purchase a license to use these items based on creator specifications. More information on in-world purchases can be found [here](https://developers.meta.com/horizon-worlds/learn/documentation/mhcp-program/monetization/meta-horizon-worlds-inworld-purchase-guide).
