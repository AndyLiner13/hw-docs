...
# [In-world purchase guide](#in-world-purchase-guide)
...
## [What is an in-world item?](#what-is-an-in-world-item)
...
| Desktop Editor                                                                                 | VR                                                                                             |
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| ![](../../.assets/image/0adebb3e00e0b384241735e234dde36a46c42697615b6378bc5c3c18c402955e.png) | ![](../../.assets/image/c8a8ab69824434724ef7469be95db400cbd5fd6c07545c658a8d8bf91ea8edde.png) |
...
| Desktop Editor                                                                                 | VR                                                                                             |
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| ![](../../.assets/image/f27d8004d6591060ade1c9c7ff7cc73845084dfc6ab9014017160833528c1234.png) | ![](../../.assets/image/37a7eaeefb06277431ecd04a7f6426c0a71335a3d5cc593d07b71bf42298987b.png) |
...
## [Creating a consumable item pack](#creating-a-consumable-item-pack)
...
| Desktop Editor                                                                                 | VR                                                                                             |
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| ![](../../.assets/image/727274e03ffa8bb3fdc1c30fd325662e1b9a39ad4f3f16f4c8d27355cd59b6e1.png) | ![](../../.assets/image/f704acfdfd2b691eb534b0f3f8f5f7f71040b172a3d7b128e60e7357f04cbcc4.png) |
...
## [Setting up an in-world purchase gizmo](#setting-up-an-in-world-purchase-gizmo)
...
| Desktop Editor                                                                                 | VR                                                                                             |
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| ![](../../.assets/image/3b9f8d709abf43b6781ffc7318436135cd604b4765f06c3ce4eedc0c4e618756.png) | ![](../../.assets/image/791bb1d3dd15c739721c0816d7eed9e7509b4a7131fe1d7d87a03c689abf7d1d.png) |
...
## [Setting up code blocks (with examples)](#setting-up-code-blocks-with-examples)
...
### [Purchase event listener](#purchase-event-listener)
...
![](../../.assets/image/7695d17947b89c1be389819fc754aa8e19e347822ad9ad2db09cdfcbf6b72cef.png)
...
### [Entitlement check operator](#entitlement-check-operator)
...
![](../../.assets/image/49a48f31aee042662ff8f476200bc09f3dbcdf985bc72f12e4cc7be7baff2325.png)
...
![](../../.assets/image/29b9ac1dd62c46a0ec189bb8fd6032b846e064ae0ab84e5fb6548f00f616103e.png)
...
1. Immediately after they successfully purchase a consumable that’s set to be ‘auto-consumed.’
2. They consume something from their inventory and it’s confirmed by “consume \[item] for \[player]”. See below.

#### [Consume item request](#consume-item-request)

1. **Listen for consume-requests:** When a player attempts to use a consumable item, `CodeBlockEvents.OnItemConsumeStart` is broadcast. You need to listen to this event and handle it; if you do not, then the item will not be consumed.
2. **Decide whether to consume:** When you receive the event you need to decide if you want the player to consume the item.
...
4. **Otherwise, ignore:** If you don’t call `consumeItemForPlayer` (because you don’t want them to consume it) then the request will timeout and send a `OnItemConsumeComplete` event with success set to `false`.
...
![](../../.assets/image/e1ac52291e4d58123c09012c0c3b92f61295e6a06b18efa5ad9e549751b335c1.png)
...
### [Pack item consume](#pack-item-consume)
...
### [Self-contained asset script](#self-contained-asset-script)
...
![](../../.assets/image/dda321b32f17dee44a1aa31e38ac6a0636468fd6b650682ec6c67e03bb6694ff.png)

![](../../.assets/image/10dc2c834fc3d9c89eedf80dcaf33cddff4f9499f8666cfa2aa8020d4cfd8e45.png)
...
## [Creator Control of Shops & Inventories](#creator-control-of-shops--inventories)
...
## [Player user interface (UI)](#player-user-interface-ui)
...
![](../../.assets/image/df57cde23cf5b9afafa6914e3a9445363bb441d45784f1ed5b5e7fc402b2854f.png) or ![](../../.assets/image/20b01324292f1cd93fbbc2d9316d48b6aa76cafc22d7533ee6d23241060ef3a2.png)
...
![](../../.assets/image/f4528241028f041e27bd0e923c5455c8a9273e344d25eb6aad3e000f760076a6.png)
...
![](../../.assets/image/b885f46797b8c62168fc820972e8a300d586e8e5e276739f049e84ad3fdd261a.png)
