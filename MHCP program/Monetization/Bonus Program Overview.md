...
# [Bonus Program Overview](#bonus-program-overview)
...
To track the progress of your bonus, go to the [Developer Dashboard](https://developers.meta.com/horizon/manage/) and navigate to **Creator Program** > **Bonuses**. For more information, please review the [Bonus Program Analytics](Bonus%20Program%20Analytics.md) article.
...
## [Time Spent on Headset bonus](#time-spent-on-headset-bonus)
...
## [Time Spent on Mobile bonus](#time-spent-on-mobile-bonus)

This bonus rewards creators for building worlds that attract the most time spent on mobile devices.

- **Eligibility:** Creator’s worlds that reach at least 50 hours of eligible time spent on mobile devices for the bonus period. Eligible time spent is determined by making adjustments to total time spent in a world to remove time spent by creators, collaborators, and playtesters, and to account for any form of suspicious engagement, including unregistered bots or networks of policy-violating user accounts.
- **How the bonus is calculated:** A creator’s share of the monthly bonus pool is based on the percentage of time spent in their eligible worlds out of the total eligible time spent on mobile devices across all Creator Program worlds.
...
## [In-World Purchase bonus](#in-world-purchase-bonus)
...
## [Mobile milestone rewards](#mobile-milestone-rewards)
...
- [Learn how to adapt your worlds for mobile devices](../Focus%20sessions/MHCP%20Session%20Deep%20Dive%20Meta%20Horizon%20Worlds%20with%20Andy%20Sargeant.md)
- [Crash course on designing mobile-first worlds](../Focus%20sessions/Mobile%20worlds%20crash%20course%2C%20part%201%20Getting%20Started.md)
- [Viral games ideas for mobile worlds](../Focus%20sessions/Mobile%20worlds%20crash%20course%2C%20part%202%20Viral%20game%20ideas.md)
...
## [Bonus enrollment](#bonus-enrollment)
...
Enrollment is available via the **Creator Program > Bonuses** tab of the [Developer Dashboard](https://developers.meta.com/horizon/manage/), and enrolled members are eligible to earn for the first 28 days of the month, regardless of when in the month they sign up.
...
Creators participating in any monetization programs, including in-world purchases and creator bonuses, are required to follow all Meta Horizon Worlds policies in order to be eligible for earnings, including the [Code of Conduct for Virtual Experiences Policy](https://www.meta.com/legal/quest/code-of-conduct-for-virtual-experiences/) and [Meta Horizon Worlds Content Guidelines](../../Save%2C%20optimize%2C%20and%20publish/Worlds%20content%20guidelines.md).
