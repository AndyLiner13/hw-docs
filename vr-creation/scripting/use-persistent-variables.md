...
The following instructions are specific to VR creation. Information on using persistent variables in the desktop editor can be found [here](/hw-docs/typescript/getting-started/persistent-variables-v2#known-issues-and-limitations).
