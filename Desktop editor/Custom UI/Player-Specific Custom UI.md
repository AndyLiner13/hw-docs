...
Therefore, the correct implementation for the button with hover state needs to take [the acting player](/hw-docs/Desktop%20editor/Custom%20UI/Build%20an%20interactive%20custom%20UI.md) into account, and only manipulate the player specific value:
