...
# [Player-Specific Custom UI](#player-specific-custom-ui)
...
## [Setting New Values for Only Certain Players](#setting-new-values-for-only-certain-players)
...
### [Global Value vs Player Values](#global-value-vs-player-values)
...
### [What about Map Functions?](#what-about-map-functions)
...
### [Setting Player Values on Start](#setting-player-values-on-start)
...
## [Player-Specific UI Example – A Case Study](#player-specific-ui-example--a-case-study)
