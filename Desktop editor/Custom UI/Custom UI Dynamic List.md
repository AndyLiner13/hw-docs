...
# [Custom UI Dynamic List](#custom-ui-dynamic-list)
...
### [Dynamic list API](#dynamic-list-api)
...
#### [`renderItem: (item: T, index?: number) => UINode`](#renderitem-item-t-index-number--uinode)
...
### [How to create a dynamic list component](#how-to-create-a-dynamic-list-component)
...
### [How to update a dynamic list during runtime](#how-to-update-a-dynamic-list-during-runtime)
...
### [How to use multiple dynamic lists](#how-to-use-multiple-dynamic-lists)
...
### [How to use dynamic lists in local mode](#how-to-use-dynamic-lists-in-local-mode)

Similar to other custom UI components, dynamic lists work well in local mode. Please refer to the [custom ui local mode documentation](Local%20Mode%20Custom%20UI%20Scripts.md) for more information on the local mode feature.
