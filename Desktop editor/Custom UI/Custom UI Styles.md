...
The available styles for [customizing](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Create%20a%20custom%20UI%20panel.md) UI panels in your world are defined in the type aliases of the [UI](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Abstract%20Classes/UIComponent.md) API, such as the [ColorValue](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ColorValue.md) type. This topic describes the available style for each type.

Type aliases:

## LayoutStyle

API documentation: [LayoutStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/LayoutStyle.md) type alias.

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| display | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<'none' \| 'flex'>` | [Default: `'flex'`]   Similar to `display` in CSS, but only supports ‘none’ and ‘flex’. The display mode of the UI element.  `none`: The UI element is not rendered.  `flex`: The UI element is displayed as a block. This is the default value. |
| height | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<number \| string>` | Similar to `height` in CSS, but only supports points and percentages. Ems and other units are not supported. |
| width | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<number \| string>` | Similar to `width` in CSS, but only supports points and percentages. Ems and other units are not supported. |
...
API documentation: [BorderStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/BorderStyle.md) type alias.

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| borderColor | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md) | Works like `border-color` in CSS. The color of the border. |
...
| borderWidth | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<number>` | Works like `border-width` in CSS, but only supports points. The width of the border. |
...
API documentation: [ShadowStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ShadowStyle.md) type alias.

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| shadowColor | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](https://developers.meta.com/horizon-worlds/learn/documentation/typescript/api-references-and-examples/custom-u) | The drop color of the shadow. |
...
| shadowOpacity | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<number>` | The opacity of the shadow. The number is multiplied by the color’s alpha component, and should be in the range from ‘0.0’ to ‘1.0’. |
...
API documentation: [TransformStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/TransformStyle.md) type alias.

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| transform | `Array<{rotate:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<string>}` `\| {scale:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>}` `\| {scaleX:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>}` `\| {scaleY:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>}` `\| {translate:[[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>,[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>]}` `\| {translateX:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>}` `\| {translateY:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<number>}` `\| {skewX:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<string>}` `\| {skewY:[`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)<string>}` | `transform` accepts an array of transformation objects. Each object specifies the property that will be transformed as the key, and the value to use in the transformation.   `rotate`: Rotate the element around the `transformOrigin`. Value requires a string expressed in degrees (e.g. ‘45deg’ ) or radians (e.g. ‘0.7854rad’).   `scale`: Scale the element uniformly by the given multiplier, with the `transformOrigin` being the fixed point. Equivalent to providing the same value to both `scaleX` and `scaleY`.   `scaleX`: Scale the element horizontally by the given multiplier.   `scaleY`: Scale the element vertically by the given multiplier.   `translate`: Move the element by the given x and y values in [x, y] format. Equivalent to providing the values to `translateX` and `translateY` independently.   `translateX`: Move the element horizontally by the given value in pixels.   `translateY`: Move the element vertically by the given value in pixels.   `skewX`: Skew the element horizontally by the given angle, represented in degrees or radians.   `skewY`: Skew the element vertically by the given angle, represented in degrees or radians. |
...
API documentation: [ViewStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ViewStyle.md) type alias.

Inherits the [LayoutStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/LayoutStyle.md), [BorderStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/BorderStyle.md), [ShadowStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ShadowStyle.md), and [TransformStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/TransformStyle.md) type aliases.

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| backgroundColor | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md) | Works like `'background-color'` in CSS. The background color of the component. |
...
| opacity | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<number>` | Set an opacity for the component. The number should be in the range from ‘0.0’ to ‘1.0’. |
| gradientColorA | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md) | The starting color of the gradient background. |
| gradientColorB | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md) | The ending color of the gradient background. |
...
API documentation: [TextStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/TextStyle.md) type alias.

Inherits the [ViewStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ViewStyle.md) type alias. Italics are not supported, and there are only a limited number of custom fonts available.

| **Name** | **Type** | **Description** |
| --- | --- | --- |
| color | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md) | [Default: `'white'`]  The color of the text. |
| fontFamily | `string` | [Default: `'Roboto'`]  The font family of the text. |
| fontSize | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<number>` | [Default: `'20'`]  The font size of the text. |
| fontWeight | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<'normal'` `\| 'bold'` `\| '100'` `\| '200'` `\| '300'` `\| '400'` `\| '500'` `\| '600'` `\| '700'` `\| '800'` `\| '900' >` | [Default: `'normal'`]  The font weight. Not all fonts have all the weight variations. If the specified variation does not exist, it will fallback to the closest one. |
...
| textDecorationLine | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)`<'none' \| 'underline' \| 'line-through' \| 'underline line-through' >` | Additional text decorations. |
| textShadowColor | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<[ColorValue]>`](https://developers.meta.com/horizon-worlds/learn/documentation/typescript/api-references-and-examples/custom-ui) | The color of the text shadow. Text shadow is only drawn when a nonzero textShadowOffset is set. |
...
API documentation: [ImageStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ImageStyle.md)

Inherits the [ViewStyle](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Type%20Aliases/ViewStyle.md) type alias.
...
| tintColor | [`Bindable`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md)[`<ColorValue>`](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Video%20presentation%20of%20creating%20performant%20custom%20UIs%20in%20Meta%20Horizon%20Worlds.md) | Changes the color of all the non-transparent pixels to the `tintColor`. |
