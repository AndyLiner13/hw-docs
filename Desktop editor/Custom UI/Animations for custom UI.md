...
# [Animations for custom UI](#animations-for-custom-ui)
...
## [Animated Binding class](#animated-binding-class)
...
## [Configure an animation](#configure-an-animation)
...
## [Interrupt or stop an animation](#interrupt-or-stop-an-animation)
...
## [Callback when the animation ends](#callback-when-the-animation-ends)
...
## [Player-specific UI](#player-specific-ui)
...
Try the tutorial world [Animation effects](../../Tutorials/Feature%20samples/Custom%20UI%20examples%20tutorial/Station%209%20-%20Animation%20Effects.md).
