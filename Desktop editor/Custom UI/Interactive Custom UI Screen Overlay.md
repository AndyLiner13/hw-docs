...
# [Interactive Custom UI Screen Overlay](#interactive-custom-ui-screen-overlay)
...
![interactive overlay.gif](../../_assets/gifs/de0f21a79027ee882058da792b0f8e8352d6c72458bbd4e164a031565e264d69.gif)
...
![](../../_assets/images/05818f68d2396d2c0f0ebd92c43545175ae0b46169847e0979f17a1f5e08e586.png)

You can test the interaction by adding a Pressable component to your UI script.

#### [Pressable pseudo code:](#pressable-pseudo-code)
...
## [Input behavior when using Interactive, Blocking Screen Overlay](#input-behavior-when-using-interactive-blocking-screen-overlay)
...
## [Input behaviour when using Interactive, Non-Blocking Screen Overlay](#input-behaviour-when-using-interactive-non-blocking-screen-overlay)
