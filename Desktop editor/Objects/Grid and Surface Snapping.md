...
# [Grid and Surface Snapping](#grid-and-surface-snapping)
...
![](../../.assets/image/2dbb4628aeaecf96f42af90be79587f663fc7ae6b8a774b0a770188a109fa43c.png)
...
### [Snapping Hotkey](#snapping-hotkey)
...
## [Snapping tools modes](#snapping-tools-modes)
...
## [Relative and Absolute snapping](#relative-and-absolute-snapping)

You can toggle between relative and absolute snapping using the dropdown.

![](../../.assets/image/f2a3f39c90fd4cf56fa55743d9f24035a993c302fbed2e4a09ab8beaee819132.png)
...
![](../../.assets/image/02dc468bbe38ac5a5f0983136d90f822dccd4b8d974958077439748f531d4042.png)
...
2. Next, click the surface snap toggle button (or hold Ctrl + Shift) to see the surface snap manipulation handle.
3. Then, drag the orange sphere handle on top of another object to surface snap the selected object to a collider.
