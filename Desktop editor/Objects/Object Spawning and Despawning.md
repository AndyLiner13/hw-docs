...
# [Object Spawning and Despawning](#object-spawning-and-despawning)
...
## [What is Object Spawning and Despawning?](#what-is-object-spawning-and-despawning)
...
## [How do we implement this feature in our world?](#how-do-we-implement-this-feature-in-our-world)

There are three approaches to implementing spawning and despawning:

1. CodeBlocks
2. TypeScript
3. TypeScript with SpawnController\
   **Tip**: This method is recommended.

### [Adding Spawning](#adding-spawning)
...
### [Adding Despawning](#adding-despawning)
...
![A view of the CodeBlocks Editor with blocks to handle spawning assets and moving them into a line.](../../_assets/images/ad75e537eeab2604cd6dd2b790382ac0c99049274cc694efdd62dfb2aaa1861e.jpg)

![A view of the CodeBlocks Editor with blocks to handle despawning assets.](../../_assets/images/9053ea85eabb88925e71f18c45847a8c1271371c94416f5b5685b455e2583c28.jpg)
...
### [Have limits in your code to control the number of objects created](#have-limits-in-your-code-to-control-the-number-of-objects-created)
...
### [Track objects to assess when they’re no longer needed](#track-objects-to-assess-when-theyre-no-longer-needed)
...
### [Object Pool Definition](#object-pool-definition)
