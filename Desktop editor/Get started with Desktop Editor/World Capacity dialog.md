...
* **Players** - The estimated simulation time for the [maximum allowed players](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Settings/Player%20Settings%20Modification.md) in the world, ranging from 0.0ms for 1-4 players up to 2.8ms for 20-32 players.
...
You can reduce vertices by using simpler meshes. See the section for “Highly detailed meshes” in [GPU best practices](/hw-mcp-tools/documentation/hw-docs/Performance/Performance%20best%20practices/GPU%20best%20practices.md#highly-detailed-meshes).
