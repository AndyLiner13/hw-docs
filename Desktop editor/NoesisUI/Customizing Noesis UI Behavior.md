...
# [Customizing Noesis UI Behavior](#customizing-noesis-ui-behavior)
...
## [Noesis Project settings](#noesis-project-settings)

### [Noesis Project](#noesis-project)
...
## [Spatial Default mode settings](#spatial-default-mode-settings)

These settings only apply when Display Mode is set to Spatial Default.

### [Show Backpanel](#show-backpanel)
...
### [Back Panel Color](#back-panel-color)
...
## [Screen Overlay mode settings](#screen-overlay-mode-settings)
...
### [Spatial vs Screen Overlay](#spatial-vs-screen-overlay)
...
### [`setLocalEntityVisibility`](#setlocalentityvisibility)
