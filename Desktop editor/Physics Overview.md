...
For more information about networking, see the [Networking Model](/hw-docs/desktop-editor/networking-model) overview.
...
* Angular Acceleration: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md) where the direction is the axis of rotation and the magnitude is in radians/second squared
* Angular Velocity: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md) where the direction is the axis of rotation and the magnitude is in radians/second
* Distance: meters
* Force: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md) with magnitude in newton’s impulse
* Impulse: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md) with magnitude in newton x seconds
* Mass: kilograms
...
* Velocity: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md) with magnitude in meters/second
...
A physical entity is an [entity](/hw-docs/desktop-editor/reference/2.0.0/core_entity) with the following properties enabled in Desktop Editor:
...
The TypeScript API also provides the [PhysicalEntity](/hw-docs/Reference/core/Classes/PhysicalEntity.md) class for creating physical entities. When using a `PhysicalEntity` object, the `locked` property must be set to `false` to enable physics.
...
For more information about the properties of physical entities, see [Using physics and animation](/hw-docs/VR%20tools/SFX/Use%20physics%20and%20animation%20in%20Meta%20Horizon%20Worlds.md).
...
* [AssetBundleGizmo](/hw-docs/Reference/unity_asset_bundles_assetbundlegizmo) class
...
* Colliders and meshes
  ...
  + To create realistic objects, you can use mesh colliders. For more information, see the [Collider Ingestion](/hw-docs/Custom%20models%20(FBX)/Creating%20custom%20models%20for%20Horizon%20Worlds/Collider%20Ingestion%20User%20Guide.md) guide.
...
* Performance panel and tracing
  ...
  + Capture high-level metrics and perform deep tracing to identify sources of performance issues related to physics and rendering. For more information, see the
    ...
    and [Tracing](/hw-docs/desktop-editor/learn/documentation/performance-best-practices-and-tooling/performance-tools/tracing) guides.

For details about physics recommendations, see [Physics best practices](/hw-docs/Performance/Performance%20best%20practices/Physics%20best%20practices.md).