...
The [World.onPrePhysicsUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) event allows you to register a callback to run on every frame before physics calculations are performed on entities. This event is typically used to move a player and then allow physics to respond to the movement.

The [World.onUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) event allows you to register a callback to run on every frame after physics calculations are performed. This event is useful for moving entities on every frame or moving a player in response to physics.

#### Spring physics

You can use spring physics to apply the physical movement of a spring to an entity when you push it toward a location or spin it toward a rotation. For more information, see the [Spring Physics](/hw-mcp-tools/documentation/hw-docs/Scripting/API%20references%20and%20examples/Spring%20Physics.md) guide. To ensure continuous motion toward the specified target, the spring physics methods must be called within the [World.onUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) event so they are called on every frame.

## Physics APIs

* [PhysicalEntity](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md) class
* [PhysicalEntity.springPushTowardPosition](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md) method
* [PhysicalEntity.springSpinTowardRotation](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md) method
...
* [World.onPrePhysicsUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) event
* [World.onPrePhysicsUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) event
...
* World update events
  ...
  + To stablize performance, distribute large physics operations across multiple frames using the The [World.onUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) event.
