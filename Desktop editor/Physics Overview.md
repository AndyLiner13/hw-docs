...
## [Delta time simulation](#delta-time-simulation)
...
## [Ownership and synchronization](#ownership-and-synchronization)
...
For more information about networking, see the [Networking Model](Network%20Model%20Overview.md) overview.
...
A physical entity is an [entity](../Reference/core/Classes/Entity.md) with the following properties enabled in Desktop Editor:
...
- Performance panel and tracing
  ...
  - Capture high-level metrics and perform deep tracing to identify sources of performance issues related to physics and rendering. For more information, see the
    ...
    and [Tracing](https://developers.meta.com/horizon-worlds/learn/documentation/desktop-editor/physics/learn/documentation/performance-best-practices-and-tooling/performance-tools/tracing) guides.
