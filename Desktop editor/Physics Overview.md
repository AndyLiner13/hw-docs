...
The physics engine on each client performs the following tasks on local entities that have physics simulation [enabled](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Physics%20Overview.md#physical_entities):
...
* Colliders: Colliders are invisible entities consisting of custom shapes that respond to physical collisions. They can include collision, physics, and grabbable components. Primitive colliders (box, sphere, and capsule) provide simplicity and optimal performance while mesh colliders more closely match the shape of an entity, although their use is more processor intensive. For more information, see the [Collider Ingestion](/hw-mcp-tools/documentation/hw-docs/Custom%20models%20(FBX)/Creating%20custom%20models%20for%20Horizon%20Worlds/Collider%20Ingestion%20User%20Guide.md) guide.
* Projectiles: A projectile is a temporary entity that is fired in a set direction before it is destroyed. You can use the [Projectile Launcher gizmo](/hw-mcp-tools/documentation/hw-docs/Gizmos/Projectile%20launcher%20gizmo.md) to manage the firing, tracking, and collision of the projectile. The launcher is accessible with the TypeScript API through the [Projectile Launcher class](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/ProjectileLauncherGizmo.md), which allows you to detect and respond to events triggered by the gizmo. For more information, see the [Projectile tutorial](/hw-mcp-tools/documentation/hw-docs/Tutorials/Simple%20Shooting%20Mechanics%20tutorial/Module%202%20-%20Projectile.md).
* Unity asset bundles: Meta Horizon Worlds supports Unity asset bundles, which provide advanced graphic and physics capabilities. With Unity Asset bundles, you can import your unity assets including Unity colliders directly into your world and even spawn the assets dynamically using the [TypeScript APIs](/hw-mcp-tools/documentation/hw-docs/Reference/unity_asset_bundles/Classes/AssetBundleGizmo.md). For more information, see the [Horizon Unity AssetBundles Overview](https://developers.meta.com/horizon-worlds/learn/documentation/desktop-editor/assets/unity-assetbundles/horizon-unity-assetbundles-overview).
...
* Angular Acceleration: [Vec3](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Vec3.md) where the direction is the axis of rotation and the magnitude is in radians/second squared
* Angular Velocity: [Vec3](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Vec3.md) where the direction is the axis of rotation and the magnitude is in radians/second
* Distance: meters
* Force: [Vec3](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Vec3.md) with magnitude in newton’s impulse
* Impulse: [Vec3](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Vec3.md) with magnitude in newton x seconds
* Mass: kilograms
* Torque: [Vec3](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Vec3.md) where the direction is the axis of rotation and the magnitude is in newton-meters
* Velocity: [Vec3](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Vec3.md) with magnitude in meters/second
...
* Collision handling
* Physical effects, such as [spring physics](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Physics%20Overview.md#spring_physics)
* [Physics materials](/hw-mcp-tools/documentation/hw-docs/VR%20tools/SFX/Use%20physics%20and%20animation%20in%20Meta%20Horizon%20Worlds.md#physics-materials), which are a collection of physics settings that emulate real-world behaviors, such as a feather, ice, or a rubber ball.
...
The TypeScript API also provides the [PhysicalEntity](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md) class for creating physical entities. When using a `PhysicalEntity` object, the `locked` property must be set to `false` to enable physics.
...
For more information about the properties of physical entities, see [Using physics and animation](/hw-mcp-tools/documentation/hw-docs/VR%20tools/SFX/Use%20physics%20and%20animation%20in%20Meta%20Horizon%20Worlds.md).
...
The [World.onPrePhysicsUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md#onprephysicsupdate) event allows you to register a callback to run on every frame before physics calculations are performed on entities. This event is typically used to move a player and then allow physics to respond to the movement.

The [World.onUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md#onupdate) event allows you to register a callback to run on every frame after physics calculations are performed. This event is useful for moving entities on every frame or moving a player in response to physics.

#### Spring physics

You can use spring physics to apply the physical movement of a spring to an entity when you push it toward a location or spin it toward a rotation. For more information, see the [Spring Physics](/hw-mcp-tools/documentation/hw-docs/Scripting/API%20references%20and%20examples/Spring%20Physics.md) guide. To ensure continuous motion toward the specified target, the spring physics methods must be called within the [World.onUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md#onupdate) event so they are called on every frame.

## Physics APIs

* [PhysicalEntity](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md) class
* [PhysicalEntity.springPushTowardPosition](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md#springpushtowardposition) method
* [PhysicalEntity.springSpinTowardRotation](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/PhysicalEntity.md#springpushtowardposition) method
* [ProjectileLauncherGizmo](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/ProjectileLauncherGizmo.md) class
* [RaycastGizmo](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/RaycastGizmo.md) class
* [AssetBundleGizmo](/hw-mcp-tools/documentation/hw-docs/Reference/unity_asset_bundles/Classes/AssetBundleGizmo.md) class
* [World.onPrePhysicsUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md#onprephysicsupdate) event
* [World.onPrePhysicsUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md#onprephysicsupdate) event
...
* World update events
  ...
  + To stablize performance, distribute large physics operations across multiple frames using the The [World.onUpdate](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md#onupdate) event.
* Colliders and meshes
  ...
  + To create realistic objects, you can use mesh colliders. For more information, see the [Collider Ingestion](/hw-mcp-tools/documentation/hw-docs/Custom%20models%20(FBX)/Creating%20custom%20models%20for%20Horizon%20Worlds/Collider%20Ingestion%20User%20Guide.md) guide.
...
For details about physics recommendations, see [Physics best practices](/hw-mcp-tools/documentation/hw-docs/Performance/Performance%20best%20practices/Physics%20best%20practices.md).