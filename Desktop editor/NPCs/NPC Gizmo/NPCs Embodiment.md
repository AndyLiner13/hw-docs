...
# [NPCs Embodiment](#npcs-embodiment)

# [Embodiment Options](#embodiment-options)
...
![Horizon Avatar and None embodied NPC](../../../_assets/images/7221ce73092f1a25f3c6804c6321a966cb1fdef33e8cd0aeba3633eda746797b.png)

## [Non-AI Embodied NPCs](#non-ai-embodied-npcs)
...
## [Horizon Avatar Embodied NPCs](#horizon-avatar-embodied-npcs)
...
1. `start()`
   ...
   - Sets up event listeners:
     1. When a player enters the banana trigger, the NPC starts moving toward the banana.
     2. On every frame update, the NPC checks if it should bring the banana to the player.
2. `moveToBanana()`
...
4. `bringBananaToPlayer()`
   - If the NPC has the banana and a player is present:
     1. Checks the distance between the NPC and the player.
     2. If within 2 meters, stops movement, drops the banana, clears the look target, and plays a cheer emote.
     3. Otherwise, the NPC looks at the player and moves closer.
5. `dropBanana()`
