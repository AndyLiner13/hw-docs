...
1. Choose a reset cadence for a new or existing leaderboard.
   1. In the CUI, navigate to **Systems** > **Leaderboards**. ![](../../.assets/image/4b479bdaa6f81879d120a86de2744f253fc5c8bf398547a8959e31e3072bb3e7.png)
   2. Either create a new leaderboard by selecting **Create Leaderboard**, or edit an existing leaderboard by selecting **Edit**. ![](../../.assets/image/260b42a2442bb50db531f4f8de54a1c7ec515e5abc4678d26b58e3cc6854a7b9.png)
   3. Beside **Reset frequency**, select the interval that you want. This can be Daily, Weekly, or Monthly. The value defaults to Never. ![](../../.assets/image/08a92f4d49e98b504d30c38fe34cfca487a17a888b3ad8bc26d3714e79a97f14.png)
   4. Save your changes by selecting **Save**.

2. Optional: Link a player’s persistent variable to the leaderboard reset.

   1. Set **Reset persistent variable (optional)** to Yes. ![](../../.assets/image/5e87d092a5d78af61bba6210275d913b9af0f82167a841119b169cf0b2d1db28.png)
   2. Select a persistent variable from one of the variable groups attached to this world.
      > [!Note]
      >
      > You can link only persistent variables with a number data type. ![](../../.assets/image/a39ca6d0855cb0610f15af7cddf1bed3fa9168c5694acbd48d5792f8deb44164.jpg)
...
![](../../.assets/image/d192eeaee774c0deab29b1caef26b9874ca90927e9e8d165f65f7bae76f831c8.png)
