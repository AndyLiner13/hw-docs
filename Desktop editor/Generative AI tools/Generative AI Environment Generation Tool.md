...
1. Open the desktop editor and select the **GenAI** menu from the top menu bar. Note that the **GenAI** panel may be open and visible by default in the right hand panel of the desktop editor. ![Environment Generation GenAI Panel](../../.assets/image/718f3a13714834bbacf0bb72807573db585cdbee408b4ffb932ddd639f0678da.png)
2. In the **GenAI** menu, select **Generate an Environment**.
3. Select one of the example prompts listed in the **GenAI** menu. The Environment Generation properties window will appear with the selected prompt input in the **Prompt Input** field. ![Environment Generation recommended prompts](../../.assets/image/302e14e335364de6122e859946d4025905313a586470341d152cd77781f7beb5.png)
...
![An island overgrown with golden grass](../../.assets/image/30771cb0f0cbb77bf74dbc64c2ac67366f0b9753e6ffd04bff7b04a8ed8f5ff9.png)

**Prompt**: “A forest in fall”

![A forest in fall](../../.assets/image/68bbb88d2219759d7ac2c73352342117a1776cf69dffc09fb2298b8c1d937120.png)

**Prompt**: “A spooky forest with barren trees and purple grass”

![A spooky forest with barren trees and purple grass](../../.assets/image/25fc391b0a40cad147f26f4e443b95909cbefa789745ca153ac9dc2920dc252f.png)

**Prompt**: “A desolate wasteland”

![A desolate wasteland](../../.assets/image/600d5b298d543a0f7efc3533912074cada7666176ffb46d02835ae14cbe377f2.png)
