Source: /hw-docs/Mobile%20and%20web/Create%20for%20web%20and%20mobile.mdsetting-up-worlds-for-web-and-mobile-compatibility
...
| Spawn point camera  [Guide](/hw-docs/Mobile%20and%20web/TypeScript%20APIs%20for%20mobile/Camera.md) | *Editor property* Set the player camera (1st or 3rd person) on spawning the player (e.g. at start of experience, or when moving between sections like lobby/arena). |  |
