Source: [Create for web and mobile](Create%20for%20web%20and%20mobile.md)setting-up-worlds-for-web-and-mobile-compatibility
...
| Spawn point camera  [Guide]([Create for web and mobile](Create%20for%20web%20and%20mobile.md)define-camera-web-mobile-meta-horizon-worlds) | *Editor property* Set the player camera (1st or 3rd person) on spawning the player (e.g. at start of experience, or when moving between sections like lobby/arena). |  |
