---
source: https://developers.meta.com/horizon-worlds/learn/documentation/create-for-web-and-mobile/growth-insights-series/designing-for-live-services-101-acquisition-engagement/
---

# Designing for Live Services 101 - Acquisition & Engagement
...
Additionally, a strong core loop helps keep players engaged and retained. To learn more about core loops, visit our dedicated article [here](../../Save,%20optimize,%20and%20publish/Adding%20Core%20Loops%20for%20Retention.md).
...
- **System events**. Layer on top of existing gameplay, goals, and reward structures to focus play and supercharge engagement. These are mostly run to maintain engagement levels and prevent churn.
- **Content events**. Require more front work and special earnable rewards. These are mostly used to drive higher engagement and monetization.
