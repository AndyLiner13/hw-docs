---
source: https://developers.meta.com/horizon-worlds/learn/documentation/create-for-web-and-mobile/growth-insights-series/designing-for-live-services-101/
---

# Designing for Live Services 101
...
- What a live-service game is
- Core components of a live-service game
- How you can design a new game with live services in mind
- Benefits to user acquisition, engagement, and monetization
- How to monitor and track player behavior
...
- **Endless gameplay.** One of the biggest attractions of a live service is the ability for players to engage in an almost limitless amount of gameplay over time.
- **Progression systems.** Players make incremental progress toward long-term goals, whether they’re chasing exclusive gear or leveling up a character. This steady progress can be motivating and deeply fulfilling for many players.
...
- **New content**. Live-service games regularly introduce new content, such as limited-time modes, new levels, new playable characters, or new cosmetics to purchase.
...
- **Revenue generation.** This is a major reason to consider a live-service model. Instead of a single up-front purchase, a live-service game can create a stable revenue stream through small microtransactions or recurring purchases like battle or season passes, sometimes for months, years, or even decades after launch.

## Costs and benefits of live service
...
# Hypothetical case study: Castle Quest!
...
### September-December: revenue decline
...
## What went wrong? Here’s how live services can help
