...
# Designing a mobile game economy
...
# An introduction to Horizon Worlds mobile economy bootcamp
...
# An introduction to in-game currencies

## **Premium/Hard and Soft Currencies**
...
# Best practices: premium currencies

Several best practices can help ensure clarity and player trust when designing a premium currency:

- Give the currency a distinct name and icon. Common choices include gems, diamonds, and rubies. It’s best if the name and icon are thematically relevant to the World’s narrative.
- Consider proprietary names (like V-bucks, Gil, Bells, G-coins) for stronger branding.
- Ensure premium and soft currencies are visually distinct from one another.
- Avoid designs that resemble real-world money, which may create false expectations of 1:1 value.

![](../../_assets/images/5cf7a530b7d2727056af747f85ca8ccfe10fa13930c8787257a37956872eb3f0.png)
...
# Soft currencies vs. third currencies
...
![](../../_assets/images/a6f01a35429554e1d7f230a77c38456e6ad130ed9d96cdf960072e7287b1dc4e.png)
...
![](../../_assets/images/1fba388c624abe89680fe34f9f6e3540aba174f3928080a8a8e4438fdc6c3642.png)
...
# Wallets and measuring sources and sinks
