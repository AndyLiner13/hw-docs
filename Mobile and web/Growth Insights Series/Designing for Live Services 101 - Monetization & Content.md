...
- **Durable goods.** In our Castle Quest! example, durable goods include cosmetics for the player avatar, new furnishings for the castle grounds, and generator buildings. Players keep these items permanently once they’re purchased.
- **Consumable goods**. In Castle Quest!, consumables include resources, gem packs, XP boosts, and power-up boosters. Players lose these items when they use them.
- **Quality-of-life upgrades.** These purchases improve fundamental aspects of gameplay, such as increased storage or extra production slots. They’re often bundled into battle or season passes.
- **Currency.** In Castle Quest!, the premium currency is gems and the soft currency is gold. Players use these currencies to make other purchases (durables, consumables, and more).
- **Battle / season passes**. In Castle Quest!, the season pass lets players complete a series of challenges to earn extra rewards throughout the month. Passes usually increase rewards from daily, weekly, and monthly quests and can include exclusive durable goods, consumables, and quality-of-life perks.

![Castle Quest! castle shop](../../_assets/images/d2f87a8f6c75c372c6643bc9444ace9c6ccb2333b8c3f71348d4eccc9949e2d6.png)
...
- **Competition**. If your game offers direct player-vs.-player gameplay, letting players purchase durable goods (such as units and weapons) can be a strong motivator.
- **Showing off / peacocking**. In games where players unlock purchases after milestones or where multiplayer is a big focus, some durable goods can serve as status symbols, letting big spenders show off their purchasing power.
- **FOMO (fear of missing out)**. Limited-time events and rotating store offerings can motivate players who don’t want to miss their chance at specific skins or cosmetics.
- **Completionism.** Some players are driven to complete sets or collections. Games can tap into this by designing collections that encourage repeat purchases.
- **Loss aversion.** When players are close to completing a level and fail, offering them the option to buy lives, moves, or boosters to secure the win can be another strong motivator.

![Castle Quest! limited time bundle](../../_assets/images/b8d2a396eacc515cf7c664b29fabc4ed1193e9aa4197053ed66715d74b46a4a5.png)
...
```
💡 Note: You do not need to build the entire pipeline before launch.
```
...
- **Additional gameplay**. Assume your most dedicated players will burn through all launch content within a few days. These potential superfans will consume new content as fast as you release it and will often evangelize your game to friends. A roadmap helps signal to them that more content is on the way.
...
- **Events**. At a minimum, plan to support three holiday events: Halloween, Christmas or winter, and summer. Anything on top of that, such as Valentine’s Day or St. Patrick’s Day, is a bonus. Events let you offer limited-time purchase options and tap into seasonal excitement to drive spend and playtime.
- **One new gameplay mode or variation**. Whatever experience you offer, players will eventually feel fatigue. Having a new mode or mini-game in your pipeline gives players something fresh to look forward to and can re-energize lapsed players.

![Castle Quest! 2.0 update window](../../_assets/images/c11de67522295019bf6e38e1786f5151a676578f8d6441f4fdbbac9bb6de4345.png)
...
![Castle Quest! daily login rewards](../../_assets/images/65060ac6cbb962e847cc153a4882850f9f7480b86bdf0908f92f9d7842fb36d6.png)
