...
# [Custom Input API](#custom-input-api)
...
## [Custom input APIs](#custom-input-apis)
...
#### [connectLocalInput()](#connectlocalinput)
...
#### [getPlatformKeyNames()](#getplatformkeynames)
...
#### [isInputActionSupported()](#isinputactionsupported)
...
#### [disableSystemControls() / enableSystemControls()](#disablesystemcontrols--enablesystemcontrols)
...
## [Custom Input Code Example](#custom-input-code-example)
...
### [Custom Input Script](#custom-input-script)
...
## [How to modify this script for other input actions](#how-to-modify-this-script-for-other-input-actions)
...
## [Adding Custom Icons to Buttons](#adding-custom-icons-to-buttons)
...
### [Obtaining a Texture Asset](#obtaining-a-texture-asset)
...
![Properties panel showing the textureAsset property](../../.assets/image/64fbad243a7d5f12faf1e16efa3a03e7be1625fe2355f283ffabb779b6539cd1.png)
