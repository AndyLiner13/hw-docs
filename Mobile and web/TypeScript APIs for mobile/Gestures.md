...
## [Step 1: Setup and initialization](#step-1-setup-and-initialization)
...
## [Step 2: Listening for gesture events](#step-2-listening-for-gesture-events)
...
### [Example: Connecting to gesture events](#example-connecting-to-gesture-events)
...
### [Gesture event payloads](#gesture-event-payloads)
...
#### [Touch state details](#touch-state-details)
...
## [Step 3 (Optional): Setting custom gesture detection thresholds](#step-3-optional-setting-custom-gesture-detection-thresholds)
...
### [Example: Customizing gesture options](#example-customizing-gesture-options)
...
## [Step 4: Lifecycle and cleanup](#step-4-lifecycle-and-cleanup)
