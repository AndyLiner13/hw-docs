...
## [Enter Focused Interaction mode](#enter-focused-interaction-mode)
...
> [!Note]
>
> Only custom input controls displayed via the `PlayerControls.connectLocalInput` API remain visible.
...
## [Handle touch and click input](#handle-touch-and-click-input)
...
> [!Note]
>
> please check the `interactionIndex` to ensure that you handle the touches that you intend.
...
## [Exit Focused Interaction mode](#exit-focused-interaction-mode)
...
## [Disable the exit button in Focused Interaction mode](#disable-the-exit-button-in-focused-interaction-mode)
...
## [Customize visual feedback](#customize-visual-feedback)
...
## [Focus the camera on a custom UI](#focus-the-camera-on-a-custom-ui)
