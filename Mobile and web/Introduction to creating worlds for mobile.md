...
* Ensure your world’s core functionality works on mobile. You can implement device-specific functionality using Code Blocks with [per platform scripting](/hw-mcp-tools/documentation/hw-docs/VR%20tools/Scripting/Per%20Platform%20Scripting.md).
* Ensure all text in the world is legible on mobile. You can [configure the camera](/hw-mcp-tools/documentation/hw-docs/Mobile%20and%20web/TypeScript%20APIs%20for%20mobile/Camera.md), make [screen-based UI](/hw-mcp-tools/documentation/hw-docs/Desktop%20editor/Custom%20UI/Create%20a%20custom%20UI%20panel.md), or use VFX, sounds and level geometry to communicate essential information.
* Consider portrait orientation support: In order to enable portrait orientation for your world you need to [configure camera settings for different orientations](/hw-mcp-tools/documentation/hw-docs/Gizmos/Spawn%20point%20gizmo.md#mobile-camera-options) and use the [Portrait Camera API](/hw-mcp-tools/documentation/hw-docs/Scripting/API%20references%20and%20examples/Portrait%20Camera%20API.md) for orientation detection.
* Set up grabbable entities so a player’s avatar holds objects in a natural and usable way. Learn how to [create grabbable entities for web and mobile players in Meta Horizon Worlds](/hw-mcp-tools/documentation/hw-docs/Mobile%20and%20web/Grabbable%20entities/Grabbable%20Entities%20On%20Mobile%20And%20Web.md).
...
For more information on testing your world on mobile and web visit [Testing worlds on mobile and web](/hw-mcp-tools/documentation/hw-docs/Mobile%20and%20web/Testing%20worlds%20on%20mobile%20and%20web.md).
...
To exclude your world from being available on mobile, or for more information on the world review and tagging process visit [Publishing worlds on mobile](/hw-mcp-tools/documentation/hw-docs/Mobile%20and%20web/Publishing%20worlds%20on%20mobile.md).