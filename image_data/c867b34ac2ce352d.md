...
### Spacing & Layout
- **Padding**: ~16px around the objective boxes.
- **Margins**: ~16px between the objective boxes and the "Actions" section.
...
- **Dropdowns**: 
  - **Example PPV**: 
    - **Element type and label**: Dropdown menu for selecting a persistent variable.
    - **Visual state**: Active state, showing a dropdown arrow.
...
- **Borders**: Solid dark gray borders around the objective boxes.
