---
source: https://developers.meta.com/horizon-worlds/learn/documentation/tutorial-worlds/genre-samples/horizon-traversal-sample-world/module-3-player-movement-systems
---

# [Module 3 - Player Movement Systems](#module-3---player-movement-systems)
...
## [PlayerControllerManager.ts](#playercontrollermanagerts)

Manages the local player control inputs, initializing them and managing ownership. Also, provides an interface for setting double-jump, boost-jump, and boost-jump angle properties.
...
## [PlayerControllerLocal.ts](#playercontrollerlocalts)

Local Script that takes the Players input and allows for doublejump and boost jumping. Additionally, for responsiveness of game effects, it also plays SFX and VFX for players.
