...
# [Module 5 - Floating Text Manager](#module-5---floating-text-manager)
...
![Image of floating text above pistol](../../../_assets/images/3e843c5523713641c2e4c2de660b9bbef3914df29e5051289a3373aad4de034d.png)
...
1. Copy the text of the scripts and their dependent scripts into scripts that you create in your world.
2. Create a FloatingTextManager reference object. Attach `FloatingTextManager.ts` to it.
3. Add in a Text Gizmo. Configure it to display the text in a format that you prefer. Attach `FloatingText.ts` to it.
...
### [Multiple FloatingText instances](#multiple-floatingtext-instances)
