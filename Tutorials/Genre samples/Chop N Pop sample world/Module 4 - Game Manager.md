---
source: https://developers.meta.com/horizon-worlds/learn/documentation/tutorial-worlds/genre-samples/chop-n-pop-sample-world/module-4-game-manager
---

# [Module 4 - Game Manager](#module-4---game-manager)
...
**Note**: This Game Manager begins gameplay based on at least one player crossing into a Trigger Zone. If your game begins as soon as a player enters the world, additional modifications are required. See “Modifications” below.
...
- **Game over**:
  - When all waves defined in the `EnemyWaveManager.ts` script have been completed, the event triggering the GameOver sequence is fired. All players are returned to the Lobby, and a new set of waves is initiated.
...
2. Attach `GameManager.ts` to a GameManager reference object.
   1. **Tip**: If your world is an FBS world, you can create an asset template directly from the GameManager reference object in your clone of this world. This method does not work for non-FBS worlds.
...
### [Change Timer and Message](#change-timer-and-message)
...
### [Trigger on player enters world](#trigger-on-player-enters-world)
