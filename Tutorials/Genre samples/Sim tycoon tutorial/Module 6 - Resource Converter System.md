...
# [Module 6 - Resource Converter System](#module-6---resource-converter-system)
...
### [ResourceConverter.ts](#resourceconverterts)

This script contains two parts:

1. **convertOre()** – A function that handles the conversion process.
2. **OreToCurrencyTrigger** – A trigger component that detects when a player enters and calls the conversion.
