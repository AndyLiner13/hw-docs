---
source: https://developers.meta.com/horizon-worlds/learn/documentation/tutorial-worlds/genre-samples/sim-tycoon-tutorial/module-5-backpack
---

# [Module 5 - Backpack (Tool)](#module-5---backpack-tool)
...
1. Add `backpack.ts` to your project.
2. Create a backpack entity in the world.
3. Attach `backpack.ts` to the entity.
4. Set the capacity property to adjust how many resources it can store.
5. If you are adding a new tool, make sure to add it to the save game data.
