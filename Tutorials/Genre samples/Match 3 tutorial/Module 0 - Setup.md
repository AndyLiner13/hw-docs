...
### [Module 1: Foundation & Core Mechanics](#module-1-foundation--core-mechanics)
...
### [Module 2: Game Flow & Scoring](#module-2-game-flow--scoring)
...
### [Module 3: Advanced Features](#module-3-advanced-features)
...
### [Module 4: Progression Systems](#module-4-progression-systems)
...
### [Customize your own Match 3 game](#customize-your-own-match-3-game)
...
## [Play the Finished Game](#play-the-finished-game)
...
1. Open the [Meta Quest Link](../../../Get%20started/Install%20the%20desktop%20editor.md) application on your desktop.
2. In the **Library tab**, locate the **Meta Horizon** application.
