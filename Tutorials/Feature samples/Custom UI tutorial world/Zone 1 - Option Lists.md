---
source: https://developers.meta.com/horizon-worlds/learn/documentation/tutorial-worlds/feature-samples/custom-ui-tutorial-world/zone-1-option-lists
---

# [Zone 1 - Option Lists](#zone-1---option-lists)

This zone focuses on various types of option lists that provide players with interactive choices.

## [Station #1: Toggle List](#station-1-toggle-list)
...
#### [ToggleList Properties](#togglelist-properties)
...
#### [ToggleListDemo Properties](#togglelistdemo-properties)
...
#### [ToggleList Methods](#togglelist-methods)
...
## [Station #2: Radio List](#station-2-radio-list)
...
## [Station #3: Task List](#station-3-task-list)
...
## [API Example #1: Options](#api-example-1-options)
