...
# [Module 6 - Fixed Camera and Cutscenes](#module-6---fixed-camera-and-cutscenes)
...
![Button in the world to activate the cutscene](../../../.assets/image/36a655d559e17ceba9881ede99a60ee96dcf82f939cb4de3eec37bce137b9584.png)
...
## [DoorButton.ts](#doorbuttonts)

This is a fairly simple script, which manages two events:

1. onPlayerEnterTrigger causes a LocalEvent to be emitted to the entity specified in the this.props.doorCutScene, referring to the reference object to which the `DoorCutScene.ts` is attached. This event triggers the camera dolly and cutscene animation.
2. After the animation is completed and the PlayerCamera has returned to the player’s perspective, `DoorCutScene.ts` sends an event back to this script, which re-enables the magic green button for replay.
...
## [Trigger the Camera Dolly and Environment Animation](#trigger-the-camera-dolly-and-environment-animation)
...
### [playEnvironmentAnimation](#playenvironmentanimation)
