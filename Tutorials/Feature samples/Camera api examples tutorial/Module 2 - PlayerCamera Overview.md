...
# [Module 2 - PlayerCamera Overview](#module-2---playercamera-overview)
...
![First-Person Camera Station](../../../.assets/image/c61d51173a028d962c4fc6b21d4e425d05433c03104c6595bdb10a3891cb07ec.png)
...
## [Set Initial PlayerCamera Point of View](#set-initial-playercamera-point-of-view)
...
## [Camera Perspectives](#camera-perspectives)
...
## [Required Camera Entities](#required-camera-entities)
...
![PlayerCamera core entities](../../../.assets/image/5a004be85ef533999e8c45fe34d8eb5f28ac056a1e650b1c84647f9e86446754.png)
...
## [PlayerCamera events](#playercamera-events)
...
### [SetCameraFixedPosition](#setcamerafixedposition)
...
### [SetCameraFixedPositionWithEntity](#setcamerafixedpositionwithentity)
...
### [RevertPlayerCamera](#revertplayercamera)
...
### [OnCameraResetPressed](#oncameraresetpressed)
...
#### [Define Camera Reset button](#define-camera-reset-button)
...
## [To Use a PlayerCamera](#to-use-a-playercamera)
...
4. Duplicate the PlayerCamera reference object, with attached `PlayerCamera.ts` script, so that there are the same number of PlayerCamera entities as the max capacity of avatars for your world.
   1. **Tip**: You can set the maximum number of players for your world. In the desktop editor, select **Meta Horizon menu > Player Settings**.
