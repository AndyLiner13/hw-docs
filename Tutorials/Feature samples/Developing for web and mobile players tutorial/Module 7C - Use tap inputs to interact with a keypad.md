...
# [Module 7C - Use tap inputs to interact with a keypad](#module-7c---use-tap-inputs-to-interact-with-a-keypad)
...
![Screenshot of the Keypad node displayed in the Hierarchy panel and in the main viewport of the desktop editor](../../../_assets/images/5a6d7daa2eea91b25d80d44895d25c169ff8a8087c2cae015a800d1dc7e1bd99.png)
...
## [Define Keypad events](#define-keypad-events)
...
## [KeypadButton script](#keypadbutton-script)
...
## [RoomB\_Keypad script](#roomb_keypad-script)
...
#### [Process Focus mode inputs:](#process-focus-mode-inputs)

We can now interact with the keypad to enter Focus mode, but we are not processing the input yet.

1. We must listen to the OnFocusedInteractionInputEnded event to check where the user has clicked.
