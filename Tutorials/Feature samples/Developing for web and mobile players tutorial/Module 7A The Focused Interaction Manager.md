...
# [Module 7A: The Focused Interaction Manager](#module-7a-the-focused-interaction-manager)
...
## [Focused Interaction events](#focused-interaction-events)
...
## [sysFocusedInteractionManagerServer script](#sysfocusedinteractionmanagerserver-script)
...
## [Build sysFocusedInteractionManagerLocal](#build-sysfocusedinteractionmanagerlocal)
...
![Screenshot of Properties panel for sysFocusedInteractionManagerLocal script being set to execute in Local mode](../../../_assets/images/bbed947c8d759de1c5a209456a728fdcd155e80d620c9bdf7d203cdce116ef23.png)
...
#### [OnStartFocusMode event listener:](#onstartfocusmode-event-listener)
...
#### [OnPlayerExitedFocusMode event listener:](#onplayerexitedfocusmode-event-listener)
...
#### [Process inputs in Focus mode:](#process-inputs-in-focus-mode)
...
## [Assign Focused Interaction Managers to players](#assign-focused-interaction-managers-to-players)
...
#### [Count Focused Interaction Managers:](#count-focused-interaction-managers)
...
![Screenshot of Hierarchy panel showing the collection of FocusedInteractionManager entities](../../../_assets/images/d9795b1b3180f1aee357c45950b7370351b7a5801a5136be8535ee5c9fd5ff3a.png)
...
![Screenshot of local version of focused interaction manager with the FIManager gameplay tag applied to it](../../../_assets/images/59b2b5da75796ecb10b75e398efb3e0716a2d8ba4dd5d1ba75a8cb852007ca86.png)
...
#### [Assign and unassign managers on player entry/exit](#assign-and-unassign-managers-on-player-entryexit)
