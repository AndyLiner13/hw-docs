...
# [Module 7B - Use drag inputs to rotate objects](#module-7b---use-drag-inputs-to-rotate-objects)
...
![Screenshot of the desktop editor displaying an object that can be rotated using drag inputs](../../../_assets/images/c4f07d40069ac46e49cb44a87eb2aaff069dbae8f95554f2937ba47920614e18.png)
...
#### [Who can grab list:](#who-can-grab-list)
...
#### [Enter Focus mode for web and mobile players:](#enter-focus-mode-for-web-and-mobile-players)
...
#### [Set object actions:](#set-object-actions)
