Source: https://developers.meta.com/horizon-worlds/learn/documentation/tutorial-worlds/feature-samples/developing-for-web-and-mobile-players-tutorial/module-8-room-c-target-practice
...
* How to build a slingshot that uses Focused Interaction for web and mobile players.

**Note**: This bifurcation of experiences needs to be tested on each device. We want to sustain the fun and competitiveness across platforms while avoiding making the world unplayable on any single device.
...
<details>
<summary>Screenshot of the teleport pad that transports visitor to appropriate location based on visitor's device type</summary>

<p></p>

[Screenshot of the teleport pad that transports visitor to appropriate location based on visitor's device type](../../../image_data/afd697398e5087dcbd112f911476f45ba18a0f49b56c1aee7c668727d19f23d9.md)
...
<details>
<summary>Screenshot of the raycast gizmo linked to the slingshot, which enables it to be used for aiming the slingshot</summary>

<p></p>

[Screenshot of the raycast gizmo linked to the slingshot, which enables it to be used for aiming the slingshot](../../../image_data/0e83fdbce56a6408c5f11af0bd83612d83a72bb860d7925b6af99b2c9c5a8e59.md)
...
The RoomC\_Slingshot script is already attached to the RoomC\_SlingshotStartTrigger entity. Open the RoomC\_Slingshot script and within the start() function, locate the following TODO:
...
In the start() function of the RoomC\_Slingshot script, locate the following TODO:
...
RoomC\_SlingshotRopeL and RoomC\_SlingshotRopeR have the same RoomC\_SlingshotRope script attached. Open the script and locate the following TODO:
...
* Learned how to combine Focused Interaction with physics to build a physics skill game for web and mobile players.
