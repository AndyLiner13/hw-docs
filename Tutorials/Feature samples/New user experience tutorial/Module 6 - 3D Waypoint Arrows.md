...
# [Module 6 - 3D Waypoint Arrows](#module-6---3d-waypoint-arrows)
...
## [Implement the 3D waypoint arrow components](#implement-the-3d-waypoint-arrow-components)
...
### [Understanding the arrow system architecture](#understanding-the-arrow-system-architecture)
...
### [Setup the arrow assignment system](#setup-the-arrow-assignment-system)
...
1. **Create the arrow assignment manager**: Create an empty object in your world to house the arrow assignment system. Attach the `ArrowAssignManager.ts` script to this object.
   ...
   ![Arrow assignment manager](../../../_assets/images/700c24719fe7b0351d25441f2e627acaa269b5ecf4a1ff6e2140db98927f0cb5.png)
...
### [Configure arrow behavior and visuals](#configure-arrow-behavior-and-visuals)
...
### [Advanced arrow system features](#advanced-arrow-system-features)
...
### [Understanding the spawn and assignment process](#understanding-the-spawn-and-assignment-process)
...
### [Testing your 3D arrow implementation](#testing-your-3d-arrow-implementation)
...
![Arrow assignment example](../../../_assets/images/882eb62da7bdfda33c24d6e2ce677cfa032e2dda40e2439db7b9996dac379d77.png)
