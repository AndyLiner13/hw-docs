---
source: https://developers.meta.com/horizon-worlds/learn/documentation/tutorial-worlds/feature-samples/spawning-and-pooling-in-typescript/module-2-implement-object-spawning
---

# [Module 2 - Implement Object Spawning](#module-2---implement-object-spawning)
...
## [The Spawning Script](#the-spawning-script)
...
- In this case, LocalEvents are used to send custom messages between code files or entities.
  - LocalEvents are messages that can be passed between scripts running on the local device. These events can pass parameterized information with them. For more information, see [Local Events](../../../Scripting/Events/Local%20Events.md).
  - **If you need to create an event that passes a message between specified entities, use a LocalEvent.**

## [Attach SimpleSpawn Script](#attach-simplespawn-script)
...
## [Triggering Spawn and Despawn](#triggering-spawn-and-despawn)
...
### [Externalize number of assets to spawn](#externalize-number-of-assets-to-spawn)
...
### [Spawn via timer](#spawn-via-timer)
