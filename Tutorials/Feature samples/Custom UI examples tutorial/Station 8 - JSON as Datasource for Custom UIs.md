...
# [Station 8 - JSON as Datasource for Custom UIs](#station-8---json-as-datasource-for-custom-uis)

> [!Note]
>
> The Text as Assets feature may not be available to all users. In the desktop editor menu bar, open the Asset Library tab. When you click **Add New**, `Text` should be one of the options. If not, this tutorial does not work for your account.
...
![Image of Station 8](../../../_assets/images/7a229484823fbb0bc773a4d4803c8ea2925fa79dd3836e39cbb96409d0d07cb7.png)
...
![Image of a Custom UI populated by JSON data](../../../_assets/images/4d64206c16bc44bdde755e5109dbad0db708342f370b4607ee85e002c0127b94.png)
...
### [LoadCUIData assets](#loadcuidata-assets)
...
### [For each custom UI kiosk](#for-each-custom-ui-kiosk)
...
### [Station08-LoadCustomUIData](#station08-loadcustomuidata)
...
#### [Parsing output object](#parsing-output-object)
...
### [Station08-DisplayCustomUI](#station08-displaycustomui)
...
#### [For the logoAssetId value](#for-the-logoassetid-value)
