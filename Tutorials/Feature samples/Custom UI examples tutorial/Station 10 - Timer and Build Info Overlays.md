...
# [Station 10 - Timer and Build Info Overlays](#station-10---timer-and-build-info-overlays)
...
![Image of Timer and Build Info overlays](../../../_assets/images/ec466a2c4a647b1aad52df3053ec12ba09f708fac4512ffa71a905bacfb9ba7e.png)
...
## [Safe Screen Locations](#safe-screen-locations)
...
### [Station10-BuildInfo.ts](#station10-buildinfots)
...
### [Station10-NonInteractiveOverlay.ts](#station10-noninteractiveoverlayts)
...
#### [`fctnTimedIntervalAction()` function](#fctntimedintervalaction-function)
...
#### [`fctnGameWin()` and `fctnGameOver()` functions](#fctngamewin-and-fctngameover-functions)
...
### [Station10-StopTimer.ts](#station10-stoptimerts)
