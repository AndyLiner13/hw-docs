...
![NoesisGUI Studio](../../../_assets/images/6e7ef157cc10f7ee4ebacfdd4cec8fd0f194c27f947e9ee05791887fd68eb390.png)
...
5. Select Add Existing, to import the Tutorial project
6. Navigate to the Tutorial Project folder and select the **.noesis** file
7. Download and add supported fonts from the [NoesisGUI Fonts Usage Guide](../../../Desktop%20editor/NoesisUI/Noesis%20UI%20Fonts%20Usage.md) to your project

## [Step-by-Step: Uploading Noesis Projects to Horizon Station](#step-by-step-uploading-noesis-projects-to-horizon-station)

![NoesisGUI Gizmo](../../../_assets/images/2c687a069d3969f78b1e597cd5af536e6dae0348454407010c9279fbf17035c5.png)
...
1. Ensure the project has been saved and all assets (XAML, images, scripts) are included.
2. Upload to Horizon Asset Library
...
3. Add the Noesis Gizmo to Your World
