...
* In the simple gun example, you could convert the two ammo counters to a non-interactive screen overlay (HUD) display. For more information, see [Custom UI Examples - Station 10 - Timer and Build Overlays](../Custom%20UI%20examples%20tutorial/Station%2010%20-%20Timer%20and%20Build%20Info%20Overlays.md).