...
![Image of loot examples](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/467738917_593923083145647_6646816619434916768_n.png?_nc_cat=110&ccb=1-7&_nc_sid=e280be&_nc_ohc=qZfF2jw3hS8Q7kNvwGeP4BN&_nc_oc=AdnCGyy8vvQ4TxpfVc4z-N3oZ9lyqQyMn2OOzWeXU6UP4ZZpGb_N4kXSK9HUmNHIR60&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=QROglIzL6swH1RdciW755Q&oh=00_AfnmMY_RPtuJSIBvYfj2V0T6OT5DKCUbq2qZylHEkEpAbw&oe=694BD314)
...
* **Placement of entities**: at startup, all instances of each loot type are stacked together outside of the playing area. These entities are moved via script to designated locations in the Graveyard.
  ...
  + Loot items could not be spawned in. For more information, see [Module 2 - Design Patterns](/hw-mcp-tools/documentation/hw-docs/Tutorials/Chop%20'n%20Pop%20sample%20world/Module%202%20-%20Design%20Patterns.md).
...
Scripts and their related script dependencies and assets must be deployed into your world. For more information, see “Deploying Systems” in [Module 1 - Setup](/hw-mcp-tools/documentation/hw-docs/Tutorials/Chop%20'n%20Pop%20sample%20world/Module%201%20-%20Setup.md).
