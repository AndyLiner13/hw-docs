...
### [Avoid NPOT (non power of two textures)](#avoid-npot-non-power-of-two-textures)
...
### [Make textures as small as possible](#make-textures-as-small-as-possible)
...
### [Use single-texture materials](#use-single-texture-materials)
...
## [Spawning/Despawning objects](#spawningdespawning-objects)
...
### [Use object pooling to avoid spawning and despawning objects](#use-object-pooling-to-avoid-spawning-and-despawning-objects)
