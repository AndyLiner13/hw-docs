...
- Select the **Utilities** menu if it’s not already on.
  ![](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/452532074_512527651285191_8177576968897515344_n.png?_nc_cat=105&ccb=1-7&_nc_sid=e280be&_nc_ohc=CVByi3XdO2QQ7kNvwGGUdWu&_nc_oc=AdkaIzAzsTzOzvARTJZLwGb3Bf1glM-odUt484I7rxeUrLYZyC9feECjsqWMcsDSruc&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=EeLM2Zy7zL6yLaANHPuL-A&oh=00_Afg8S6Bbfu35bFQ-BldjGWHXHTwWmwLggO-O9BD-KSdr9A&oe=692EAE75)
...
- Perform an action to start compiling metrics that you can analyze. For example, you could pick up a weapon and shoot it, use your Super Power, or shoot a drone. As a result, you might see spikes in some of the real-time graphs or other details indicating activity.
  ![](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/452814680_512527671285189_2521814497190586262_n.png?_nc_cat=105&ccb=1-7&_nc_sid=e280be&_nc_ohc=q2QoINcBEYwQ7kNvwGd2nkN&_nc_oc=AdnHp9yPgBN1moZL2yfoHxbSdw_dOIKcNvCk9LDWcjTEIvGMbaViXU8tbT_eHKUMsGM&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=EeLM2Zy7zL6yLaANHPuL-A&oh=00_Afgxklv_dU0Xk6EY0p8zkDUHF4PIaViIOAarZexDPpD8ww&oe=692EAD30)
- After you’ve put some data into the **Performance Metrics** panel, select the **Inspect** button, and scroll down to see the available metrics. Notice that spikes from the real-time graph  also appear here.
  ![](https://scontent-dfw5-1.xx.fbcdn.net/v/t39.2365-6/452589609_512527667951856_3972198912793986595_n.png?_nc_cat=110&ccb=1-7&_nc_sid=e280be&_nc_ohc=s9Oj7tDuiIUQ7kNvwG59BF6&_nc_oc=AdnJHn7E2wVc4l-yIAdwdET0GcRxNfGsIPJrOOcZIJS5BwdudrPrOnqZSNZ30_muYAU&_nc_zt=14&_nc_ht=scontent-dfw5-1.xx&_nc_gid=EeLM2Zy7zL6yLaANHPuL-A&oh=00_AfjZi5XkGRm2rW_gMv-T8KRPFXkKRYObBKidxsase8t6Zw&oe=692EA73A)
- Now you can use scrubbing to evaluate the data to identify where the performance problems are coming from. Here’s how to use scrubbing to test performance issues:
  ...
  - Move the range selection without changing its size by hovering over the middle of the blue range selector and grabbing and dragging it. This will change how the data is displayed in the graph.
    ![](https://scontent-dfw5-2.xx.fbcdn.net/v/t39.2365-6/452934094_512527661285190_955464009422810835_n.png?_nc_cat=100&ccb=1-7&_nc_sid=e280be&_nc_ohc=VhCbvuQrgQUQ7kNvwFctH_8&_nc_oc=AdkNZtFFjSDm2en8ylnUE96jOpVhCxuclPTzVG2xTM5ml-XPj09qoBGAWHPiABaoEaU&_nc_zt=14&_nc_ht=scontent-dfw5-2.xx&_nc_gid=EeLM2Zy7zL6yLaANHPuL-A&oh=00_AfhRb-AqxfVcpXZLVNzUq2zKigWN-wOcnTxuMNtFAuvtZA&oe=692E912F)
  ...
  - To move forward and backward by a set number of frames, use the **Forward** and **Backward** buttons above the graphs.
    ![](https://scontent-dfw5-3.xx.fbcdn.net/v/t39.2365-6/452694024_512527647951858_1112702379597418669_n.png?_nc_cat=108&ccb=1-7&_nc_sid=e280be&_nc_ohc=3LwEO0EsnAAQ7kNvwEvbRIg&_nc_oc=Adng93zcLkUK-MI1DCrKTYWB3uvtfE57HsbB4PSqXqqV0rLWng_VUyQSWpqsjwcMLxg&_nc_zt=14&_nc_ht=scontent-dfw5-3.xx&_nc_gid=EeLM2Zy7zL6yLaANHPuL-A&oh=00_AfhmZPJtV91yEN6TKt_zHbIM-7z_wP0n_-uBpZGqorVq0Q&oe=692E9C1A)
