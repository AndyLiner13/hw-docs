...
4. Call the samplers’ collection functions in your scripts wherever you want to record data.

## [Create custom metrics and add to your scripts](#create-custom-metrics-and-add-to-your-scripts)
...
### [Define and activate custom metrics](#define-and-activate-custom-metrics)
...
### [Measure custom metrics in your code](#measure-custom-metrics-in-your-code)
...
## [Analyze custom metric data](#analyze-custom-metric-data)

### [Viewing Data in VR](#viewing-data-in-vr)
...
### [Viewing Data in Perfetto](#viewing-data-in-perfetto)
...
1. Create a trace using the instructions in the [Tracing](Tracing.md) docs.
2. Open your browser and navigate to the [Developer Dashboard](https://developers.meta.com/horizon/manage/worlds/).
3. Select your world.
4. From the left-side navigation, select **Performance** > **Traces** to find the trace. The name of the trace file should include “custom\_metrics”.
5. Click **Open in Perfetto** to open the trace.
