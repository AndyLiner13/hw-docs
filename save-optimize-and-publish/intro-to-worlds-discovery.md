...
| --- | --- | --- | --- |
| **Appeal** *You should find content appealing in discovery.* | How well does a world get users to try the world based on art and information? | Proportion of users who have seen an impression of your world who then visit the world. | You can increase your world’s appeal by focusing on the world title, description, key art, and [thumbnail](/horizon-worlds/learn/documentation/save-optimize-and-publish/thumbnail-ab-testing-tool). |
