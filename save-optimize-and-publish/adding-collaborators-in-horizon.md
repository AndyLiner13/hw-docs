...
## Inviting collaborators with the Developer Dashboard

You can invite colalborators to your world through the Developer Dashboard using the following steps:

- Go to the [Developer Dashboard](https://developer.oculus.com/manage/worlds/).
- From the left-side icon menu, click the **Team** icon.
- Click **Invite Member**
- Provide the Meta Horizon username (case-sensitive) or email address of the collaborator you want to add.
- Choose permissions.
- Add any notes (Note that member notes will be visible to all members).
...
- Go to the [Developer Dashboard](https://developer.oculus.com/manage/worlds/).
- From the left-side navigation, click **Team Invites**.
