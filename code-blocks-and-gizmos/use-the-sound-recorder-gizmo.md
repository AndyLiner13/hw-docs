...
The sound recorder [gizmo](/hw-docs/code-blocks-and-gizmos/about-gizmos) allows you, the creator, to record custom sounds from the microphone on your desktop (if present) or headset. Each recording can be up to 20 minutes long.
...
The sound recorder gizmo is an entity. All objects in a world are represented by entities. [Entities](/horizon-worlds/reference/2.0.0/core_entity) have their respective properties such as position, rotation, and scale. In the Properties panel, you can edit the gizmo’s transformation fields to configure its **Position**, **Rotation**, and **Scale**.
...
* **Information banners**: The sound recorder properties panel provides information banners in VR for the following cases:
  ...
  **Note**: The information banners may only be available in the [VR tool](/hw-docs/vr-creation/getting-started/create-a-new-world-in-horizon).
...
* [Pre-made sound](/hw-docs/vr-creation/sfx/adding-sound-in-horizon)
...
* [How audio affects performance](/hw-docs/performance-best-practices-and-tooling/performance-tools/analyzing-trace-data-with-perfetto#audio)