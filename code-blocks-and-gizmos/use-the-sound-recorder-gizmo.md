...
* **Information banners**: The sound recorder properties panel provides information banners in VR for the following cases:
  ...
  **Note**: The information banners may only be available in the [VR tool](/horizon-worlds/learn/documentation/vr-creation/getting-started/create-a-new-world-in-horizon).
...
* [Pre-made sound](/horizon-worlds/learn/documentation/vr-creation/sfx/adding-sound-in-horizon)
