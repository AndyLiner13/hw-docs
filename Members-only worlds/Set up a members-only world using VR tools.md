...
# [Set up a members-only world using VR tools](#set-up-a-members-only-world-using-vr-tools)
...
## [Create your members-only world](#create-your-members-only-world)

Members-only worlds are a new type of closed space that is membership-based. You can turn on the Members-only setting for a world you create once the standard world creation flow is complete and your world is ready to publish.
...
## [Set rules for a members-only world](#set-rules-for-a-members-only-world)
...
## [Invite members and select roles (tester, editor, admin)](#invite-members-and-select-roles-tester-editor-admin)
