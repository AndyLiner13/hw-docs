...
props: Readonly<[TextProps](https://developers.meta.com/horizon-worlds/reference/2.0.0/ui_textprops)>

The props of the Text component.

## Returns

[UINode](https://developers.meta.com/horizon-worlds/reference/2.0.0/ui_uinode)<[TextProps](https://developers.meta.com/horizon-worlds/reference/2.0.0/ui_textprops)>
