...
For information about usage, see the [Image from Asset](/hw-docs/tutorials/tutorial-worlds/custom-ui-examples-tutorial/station-2-image-from-asset) section of the Custom UI Examples tutorial.
