...
|  |  |
| --- | --- |
| **initializeUI()** abstract | Defines the UI and sets up necessary event subscriptions. This method is called before the [UIComponent.start()](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Abstract%20Classes/UIComponent.md) method when the component is started.      Signature  ``` abstract initializeUI(): UINode; ```  Returns  [UINode](/hw-mcp-tools/documentation/hw-docs/Reference/ui/Classes/UINode.md)  Remarks  This method must return a valid UINode. |
