...
The options for the [Player.playAvatarAnimation()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md) method, which triggers an animation on an avatar.
