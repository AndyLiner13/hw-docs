...
Options for the [Player.focusUI()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md#focusui) method including settings to apply to the camera view and animation transitions.
