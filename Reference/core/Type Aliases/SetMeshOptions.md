...
For information on updating the mesh of a custom model entity, see the [MeshEntity.setMesh()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/MeshEntity.md#setmesh) method.