...
This callback is optionally provided by the [Player.playAvatarAnimation()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md) and [Player.stopAvatarAnimation()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md) methods when providing custom avatar animations.