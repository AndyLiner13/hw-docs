...
The available options for enabling Aim Assist with the [Player.setAimAssistTarget()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/Player.md) method.
