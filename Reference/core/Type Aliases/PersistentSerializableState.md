...
A state that can persist across sessions within persistent variables for each player. Used with the [getPlayerVariable](/hw-docs/Reference/core/Classes/World.md) and [setPlayerVariable](/hw-docs/Reference/core/Classes/World.md) methods.
