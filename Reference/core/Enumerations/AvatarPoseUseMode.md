...
You can set the permission list by calling the [AvatarPoseGizmo.setCanUseForPlayers()](/hw-docs/Reference/core/Classes/AvatarPoseGizmo.md#setcanuseforplayers) method.