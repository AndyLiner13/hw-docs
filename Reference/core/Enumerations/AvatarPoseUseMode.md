...
You can set the permission list by calling the [AvatarPoseGizmo.setCanUseForPlayers()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/AvatarPoseGizmo.md) method.