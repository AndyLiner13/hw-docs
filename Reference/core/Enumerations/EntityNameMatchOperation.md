...
Defines the valid matching operations that are available when using [findEntities()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Classes/World.md) to find world entities.
