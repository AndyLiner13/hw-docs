...
# [ButtonIcon Enum](#buttonicon-enum)
...
| PttAvailable  | `47`  | The Push Toggle Talk icon for Available                                   |
| PttBusy       | `48`  | The Push Toggle Talk icon for Busy                                        |
| PttListening  | `49`  | The Push Toggle Talk icon for Listening                                   |
| PttMuted      | `50`  | The Push Toggle Talk icon for Muted                                       |
| PttResponding | `51`  | The Push Toggle Talk icon for Responding                                  |
| PttThinking   | `52`  | The Push Toggle Talk icon for Thinking (between listening and responding) |
