...
Extends *[DisposableObject](../Interfaces/DisposableObject.md)*

The core class for creating new types of components and attaching functionality to [entities](../Classes/Entity.md) in a world.
