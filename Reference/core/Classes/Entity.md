...
| **lookAt(target, up)** | Rotates an entity to look at a point.      Signature  ``` lookAt(target: Vec3, up?: Vec3): void; ```  Parameters  target: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md)  The target for the entity to look at.  up: [Vec3](/hw-docs/Reference/core/Classes/Vec3.md)  *(Optional)* The up direction of the rotation. The default value is [Vec3.up](/hw-docs/Reference/core/Classes/Vec3.md).  Returns  void |
