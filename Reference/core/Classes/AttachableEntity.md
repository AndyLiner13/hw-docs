...
|  |  |
| --- | --- |
| **attachToPlayer(player, anchor)** | Attaches the entity to a player.      Signature  ``` attachToPlayer(player: Player, anchor: AttachablePlayerAnchor): void; ```  Parameters  player: [Player](/hw-docs/Reference/core/Classes/Player.md)  The player to attach the entity to.  anchor: [AttachablePlayerAnchor](/hw-docs/Reference/core/Enumerations/AttachablePlayerAnchor.md)  The attachment point to use.  Returns  void |
