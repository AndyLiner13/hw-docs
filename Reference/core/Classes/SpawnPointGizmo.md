...
For more information about using the Spawn Point gizmo, see [Spawn Points](/hw-docs/Tutorials/TypeScript%20Multiplayer%20Lobby%20tutorial/Module%205%20-%20Entering%20the%20Match.md) guide.
...
|  |  |
| --- | --- |
| **teleportPlayer(player)** | Teleports a player to the spawn point.      Signature  ``` teleportPlayer(player: Player): void; ```  Parameters  player: [Player](/hw-docs/Reference/core/Classes/Player.md)  The player to teleport.  Returns  void |
