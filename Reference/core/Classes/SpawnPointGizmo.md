...
For more information about using the Spawn Point gizmo, see [Spawn Points](/hw-docs/tutorials/multiplayer-lobby-tutorial/module-5-entering-the-match) guide.
