...
|  |  |
| --- | --- |
| **(constructor)(entity)** | Constructs a new instance of the `Transform` class.  ---  Signature  ``` constructor(entity: Entity); ```  Parameters  entity: [Entity](/hw-docs/Reference/core/Classes/Entity.md)  The entity to transform. |
