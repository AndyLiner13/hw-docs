...
### [onPrePhysicsUpdate static \[readonly\]](#onprephysicsupdate-static-readonly)
...
The [World.onPrePhysicsUpdate](World.md#onprephysicsupdate) event provides similar functionality, but after the physics engine performs calculations.For more information about subscribing to world update events, see the [World Update Events](../../../Scripting/Events/World%20Update%20Events.md) guide.

### [onUpdate static \[readonly\]](#onupdate-static-readonly)
...
By subscribing to this event, a script can perform operations during the world update loop, such as [spawning an asset](World.md#spawnasset).The [World.onPrePhysicsUpdate](World.md#onprephysicsupdate) event provides similar functionality, but before the physics engine performs calculations.For more information about subscribing to world update events, see the [World Update Events](../../../Scripting/Events/World%20Update%20Events.md) guide.

### [persistentStorage](#persistentstorage)

A persistent storage object, which contains a set of functions that interact with player variables.For information about using player variables, see the [Persistent Variables](../../../Scripting/Get%20started%20with%20TypeScript/Object%20Type%20Persistent%20Variables.md) guide.
...
### [persistentStorageWorld](#persistentstorageworld)
...
### [deleteAsset(entity, fullDelete)](#deleteassetentity-fulldelete)
...
### [findEntities(name, options)](#findentitiesname-options)
...
### [findEntity(name)](#findentityname)
...
### [getEntitiesWithTags(tags, matchOperation)](#getentitieswithtagstags-matchoperation)
...
matchOperation: [EntityTagMatchOperation](../Enumerations/EntityTagMatchOperation.md)

*(Optional)* The match operation to run when searching for entities with given tags. Defaults to [EntityTagMatchOperation.HasAnyExact](../Enumerations/EntityTagMatchOperation.md).
...
### [getPlayerFromIndex(playerIndex)](#getplayerfromindexplayerindex)

Gets the [Player](Player.md) object for the given [player index](Player.md#index).
...
The index of the player. Retrievable with the [Player.index](Player.md#index) property.
...
Gets all [players](Player.md) currently in the world, not including the server player.
...
An array of [Player](Player.md) objects in the world.

### [getServerPlayer()](#getserverplayer)
...
### [setShopOverlayVisible(player, shopGizmo, visible)](#setshopoverlayvisibleplayer-shopgizmo-visible)
...
### [spawnAsset(asset, position, rotation, scale)](#spawnassetasset-position-rotation-scale)
...
### [update(updateType, deltaTime)](#updateupdatetype-deltatime)
