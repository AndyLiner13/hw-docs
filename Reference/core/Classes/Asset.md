...
|  |  |
| --- | --- |
| **(constructor)(id, versionId)** | Creates an instance of [Asset](https://developers.meta.com/horizon-worlds/reference/2.0.0/core_asset).  ---  Signature  ``` constructor(id: bigint, versionId?: bigint); ```  Parameters  id: bigint  The ID of the asset.  versionId: bigint  *(Optional)* The version of the asset. |
