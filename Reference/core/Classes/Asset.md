...
Asset spawning excels when spawning smaller sets of dynamic content, or content that needs to spawn at different locations in a world. For larger sets of static content that always spawns at the same location in the world, the [world streaming](/hw-docs/Reference/world_streaming/Classes/SublevelEntity.md) API provides more optimal performance.
