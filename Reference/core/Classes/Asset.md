...
### [(constructor)(id, versionId)](#constructorid-versionid)

Creates an instance of [Asset](Asset.md).
...
### [versionId \[readonly\]](#versionid-readonly)
...
### [as(assetClass)](#asassetclass)

Creates an instance of [Asset](Asset.md) with the given ID.
...
assetClass: [Class](../Interfaces/Class.md)<\[bigint, bigint], T>
...
### [fetchAsData(options)](#fetchasdataoptions)
...
options: Partial<[FetchAsDataOptions](../Type%20Aliases/FetchAsDataOptions.md)>

*(Optional)* The optional settings for the asset.

**Returns**

Promise<[AssetContentData](AssetContentData.md)>
