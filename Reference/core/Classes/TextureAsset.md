...
Extends *[Asset](https://developers.meta.com/horizon-worlds/reference/2.0.0/core_asset)*

Represents a texture [Asset](https://developers.meta.com/horizon-worlds/reference/2.0.0/core_asset). A texture is a binary image that is applied over the mesh surface. Texture images can be stretched (or shrunk) and attached to a mesh.
