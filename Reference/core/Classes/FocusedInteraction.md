...
|  |  |
| --- | --- |
| **(constructor)(player)** | Creates a new `FocusedInteraction` instance.  ---  Signature  ``` constructor(player: Player); ```  Parameters  player: [Player](Player.md)  The player to assign to the focused interaction settings. |
