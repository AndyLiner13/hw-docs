...
# [CodeBlockEvent Class](#codeblockevent-class)
...
### [(constructor)(name, expectedTypes)](#constructorname-expectedtypes)
...
Each of these types defines the parameters for the event and must be of type [PropTypes](../Variables/PropTypes.md).
