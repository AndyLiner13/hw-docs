...
The Comparable interface defines a set of methods for comparing values of the same type, including [equals()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Interfaces/Comparable.md) and [equalsApprox()](/hw-mcp-tools/documentation/hw-docs/Reference/core/Interfaces/Comparable.md) methods.
