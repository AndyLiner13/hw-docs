...
|  |  |
| --- | --- |
| **mark()** | Warning: This API is now obsolete. Use [HorizonMarkerSampler.mark()](/hw-mcp-tools/documentation/hw-docs/Reference/performance/Classes/HorizonMarkerSampler.md#horizonmarkersampler-class) instead. This method is deprecated.      Signature  ``` mark(): void; ```  Returns  void |