...
# [AttachCameraOptions type](#attachcameraoptions-type)

Options used to determine the behavior of a camera in [attached mode](../Classes/Camera.md#setcameramodeattach).
