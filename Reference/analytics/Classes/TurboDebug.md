...
To use Turbo debugging, you must enable it by setting the [ITurboSettings.debug](/hw-mcp-tools/documentation/hw-docs/Reference/analytics/Interfaces/ITurboSettings.md) property to `true`.
