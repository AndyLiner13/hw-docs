...
To enable sections analytics, see the [ITurboSettings.useSections](/hw-mcp-tools/documentation/hw-docs/Reference/analytics/Interfaces/ITurboSettings.md) property.