...
### [Constants static](#constants-static)
...
To change how fast the agent reaches its max speed, use the [acceleration](NavMeshAgent.md#acceleration) property.Default: 5 meters per second
...
The agent's desired orientation is determined by its [alignmentMode](NavMeshAgent.md#alignmentmode) property.Default: 120 degrees per second
...
A string representation of the NavMeshAgent.
