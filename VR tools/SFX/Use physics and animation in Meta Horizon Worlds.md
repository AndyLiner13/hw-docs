...
# [Use physics and animation in Meta Horizon Worlds](#use-physics-and-animation-in-meta-horizon-worlds)
...
### [Physics materials comparison](#physics-materials-comparison)

<video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4"><video controls></video><source src="(BROKEN_REF)" type="video/mp4">
